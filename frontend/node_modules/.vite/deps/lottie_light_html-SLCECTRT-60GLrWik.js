...
//#region node_modules/@dotlottie/common/dist/lottie_light_html-SLCECTRT.js
var lottie_light_htmlSLCECTRT = m((Re, ni) => {
	typeof navigator < "u" && function(ye, le) {
		...
		var ye = "http://www.w3.org/2000/svg", le = "", Ci = !1, ai = -999999, As = function(e) {
			Ci = !!e;
		}, Cs = function() {
			return Ci;
		}, xs = function(e) {
		...
		var xi = !0, Mi = null, hi = "", Fs = /^((?!chrome|android).)*safari/i.test(navigator.userAgent), ct = Math.pow, Oe = Math.sqrt, ee = Math.floor, De = Math.max, be = Math.min;
		var Ii = 150, U = Math.PI / 180, Wt = .5519;
		function Gt(t) {
		...
		var we = function() {
			...
			function u() {
				s || (s = a(function(_) {
					function k() {
						function C(F, m) {
							...
							for (o = 0; o < f; o += 1) if (S = F[o], "ks" in S && !S.completed) {
								...
								S.ty === 0 ? (S.layers = p(S.refId, m), C(S.layers, m)) : S.ty === 4 ? c(S.shapes) : S.ty === 5 && G(S);
							}
						}
						function y(F, m) {
							if (F) {
								var S = 0, o = F.length;
								for (S = 0; S < o; S += 1) F[S].t === 1 && (F[S].data.layers = p(F[S].data.refId, m), C(F[S].data.layers, m));
							}
						}
						function v(F, m) {
							for (var S = 0, o = m.length; S < o;) {
								if (m[S].id === F) return m[S];
								S += 1;
							}
							return null;
						}
						...
						function c(F) {
							var m, S = F.length, o, f;
							for (m = S - 1; m >= 0; m -= 1) if (F[m].ty === "sh") if (F[m].ks.k.i) b(F[m].ks.k);
							else for (f = F[m].ks.k.length, o = 0; o < f; o += 1) F[m].ks.k[o].s && b(F[m].ks.k[o].s[0]), F[m].ks.k[o].e && b(F[m].ks.k[o].e[0]);
							else F[m].ty === "gr" && c(F[m].it);
						}
						function b(F) {
							var m, S = F.i.length;
							for (m = 0; m < S; m += 1) F.i[m][0] += F.v[m][0], F.i[m][1] += F.v[m][1], F.o[m][0] += F.v[m][0], F.o[m][1] += F.v[m][1];
						}
						function P(F, m) {
							var S = m ? m.split(".") : [
								100,
							...
							return F[0] > S[0] ? !0 : S[0] > F[0] ? !1 : F[1] > S[1] ? !0 : S[1] > F[1] ? !1 : F[2] > S[2] ? !0 : S[2] > F[2] ? !1 : null;
						}
						var x = function() {
							var F = [
								4,
							...
							function S(o) {
								var f, M = o.length;
								for (f = 0; f < M; f += 1) o[f].ty === 5 && m(o[f]);
							}
							return function(o) {
							...
							return function(m) {
								if (m.chars && !P(F, m.v)) {
									var S, o = m.chars.length;
									for (S = 0; S < o; S += 1) {
										var f = m.chars[S];
										f.data && f.data.shapes && (c(f.data.shapes), f.data.ip = 0, f.data.op = 99999, f.data.st = 0, f.data.sr = 1, f.data.ks = {
											p: {
												k: [0, 0],
												a: 0
											},
										...
										}, m.chars[S].t || (f.data.shapes.push({ ty: "no" }), f.data.shapes[0].it.push({
											p: {
												k: [0, 0],
												a: 0
											},
							...
							function m(o) {
								...
								for (f = 0; f < M; f += 1) if (o[f].ty === "gr") m(o[f].it);
							...
							function S(o) {
								var f, M = o.length;
								for (f = 0; f < M; f += 1) o[f].ty === 4 && m(o[f].shapes);
							}
							return function(o) {
								if (P(F, o.v) && (S(o.layers), o.assets)) {
									var f, M = o.assets.length;
						...
						function L(F) {
							F.__complete || (j(F), x(F), T(F), I(F), D(F), C(F.layers, F.assets), y(F.chars, F.assets), F.__complete = !0);
						}
						function G(F) {
					...
					if (n.dataManager || (n.dataManager = k()), n.assetLoader || (n.assetLoader = function() {
						function C(v) {
						...
						n.dataManager.completeData(w), n.postMessage({
							id: _.data.id,
							payload: w,
							status: "success"
						});
			...
			function r(y) {
				var v = 0, p = setInterval(function() {
					(y.getBBox().width || v > 500) && (this._imageLoaded(), clearInterval(p)), v += 1;
				}.bind(this), 50);
			}
			function n(y) {
				var v = s(y, this.assetsPath, this.path), p = O("image");
				Fs ? this.testImageLoaded(p) : p.addEventListener("load", this._imageLoaded, !1), p.addEventListener("error", function() {
					c.img = t, this._imageLoaded();
				}.bind(this), !1), p.setAttributeNS("http://www.w3.org/1999/xlink", "href", v), this._elementHelper.append ? this._elementHelper.append(p) : this._elementHelper.appendChild(p);
				var c = {
					img: p,
					assetData: y
				};
...
`), s = {}, r, n = 0, a = 0; a < i.length; a += 1) r = i[a].split(":"), r.length === 2 && (s[r[0]] = r[1].trim(), n += 1);
		...
		var N = function() {
			this._cbs = [], this.name = "", this.path = "", this.isLoaded = !1, this.currentFrame = 0, this.currentRawFrame = 0, this.firstFrame = 0, this.totalFrames = 0, this.frameRate = 0, this.frameMult = 0, this.playSpeed = 1, this.playDirection = 1, this.playCount = 0, this.animationData = {}, this.assets = [], this.isPaused = !0, this.autoplay = !1, this.loop = !0, this.renderer = null, this.animationID = dt(), this.assetsPath = "", this.timeCompleted = 0, this.segmentPos = 0, this.isSubframeEnabled = Bs(), this.segments = [], this._idle = !0, this._completedLoop = !1, this.projectInterface = Ns(), this.imagePreloader = new Os(), this.audioController = Ts(), this.markers = [], this.configAnimation = this.configAnimation.bind(this), this.onSetupError = this.onSetupError.bind(this), this.onSegmentComplete = this.onSegmentComplete.bind(this), this.drawnFrameEvent = new li("drawnFrame", 0, 0, 0), this.expressionsPlugin = Ne();
		};
		H([ji], N), N.prototype.setParams = function(t) {
			(t.wrapper || t.container) && (this.wrapper = t.wrapper || t.container);
			var e = "svg";
			t.animType ? e = t.animType : t.renderer && (e = t.renderer);
			this.renderer = new (js(e))(this, t.rendererSettings), this.imagePreloader.setCacheType(e, this.renderer.globalData.defs), this.renderer.setProjectInterface(this.projectInterface), this.animType = e, t.loop === "" || t.loop === null || t.loop === void 0 || t.loop === !0 ? this.loop = !0 : t.loop === !1 ? this.loop = !1 : this.loop = parseInt(t.loop, 10), this.autoplay = "autoplay" in t ? t.autoplay : !0, this.name = t.name ? t.name : "", this.autoloadSegments = Object.prototype.hasOwnProperty.call(t, "autoloadSegments") ? t.autoloadSegments : !0, this.assetsPath = t.assetsPath, this.initialSegment = t.initialSegment, t.audioFactory && this.audioController.setAudioFactory(t.audioFactory), t.animationData ? this.setupAnimation(t.animationData) : t.path && (t.path.lastIndexOf("\\") !== -1 ? this.path = t.path.substr(0, t.path.lastIndexOf("\\") + 1) : this.path = t.path.substr(0, t.path.lastIndexOf("/") + 1), this.fileName = t.path.substr(t.path.lastIndexOf("/") + 1), this.fileName = this.fileName.substr(0, this.fileName.lastIndexOf(".json")), we.loadAnimation(t.path, this.configAnimation, this.onSetupError));
			...
			this.animationData.__complete = !1, we.completeAnimation(this.animationData, this.onSegmentComplete);
		...
		var et = function() {
			...
			function u(m) {
				for (var S = 0, o = m.target; S < s;) e[S].animation === o && (e.splice(S, 1), S -= 1, s -= 1, o.isPaused || E()), S += 1;
			}
			function h(m, S) {
				if (!m) return null;
				for (var o = 0; o < s;) {
					if (e[o].elem === m && e[o].elem !== null) return e[o].animation;
					o += 1;
				}
				var f = new N();
				return l(f, m), f.setData(m, S), f;
			}
			function d() {
				var m, S = e.length, o = [];
				for (m = 0; m < S; m += 1) o.push(e[m].animation);
				return o;
			}
			function g() {
				r += 1, j();
			...
			function l(m, S) {
				m.addEventListener("destroy", u), m.addEventListener("_active", g), m.addEventListener("_idle", E), e.push({
					elem: S,
					animation: m
				}), s += 1;
			}
			function _(m) {
				var S = new N();
				return l(S, null), S.setParams(m), S;
			}
			function k(m, S) {
				var o;
				for (o = 0; o < s; o += 1) e[o].animation.setSpeed(m, S);
			}
			function w(m, S) {
				var o;
				for (o = 0; o < s; o += 1) e[o].animation.setDirection(m, S);
			}
			function C(m) {
				var S;
				for (S = 0; S < s; S += 1) e[S].animation.play(m);
			}
			function y(m) {
				var S = m - i, o;
				for (o = 0; o < s; o += 1) e[o].animation.advanceTime(S);
				i = m, r && !a ? window.requestAnimationFrame(y) : n = !0;
			}
			function v(m) {
			...
			function p(m) {
				var S;
				for (S = 0; S < s; S += 1) e[S].animation.pause(m);
			}
			function c(m, S, o) {
				var f;
				for (f = 0; f < s; f += 1) e[f].animation.goToAndStop(m, S, o);
			}
			function b(m) {
				var S;
				for (S = 0; S < s; S += 1) e[S].animation.stop(m);
			}
			function P(m) {
				var S;
				for (S = 0; S < s; S += 1) e[S].animation.togglePause(m);
			}
			function x(m) {
				var S;
				for (S = s - 1; S >= 0; S -= 1) e[S].animation.destroy(m);
			}
			function T(m, S, o) {
				...
				for (M = 0; M < A; M += 1) o && f[M].setAttribute("data-bm-type", o), h(f[M], m);
				if (S && A === 0) {
					o || (o = "svg");
					var B = document.getElementsByTagName("body")[0];
					B.innerText = "";
					var q = at("div");
					q.style.width = "100%", q.style.height = "100%", q.setAttribute("data-bm-type", o), B.appendChild(q), h(q, m);
				}
			}
			function I() {
				var m;
			...
			function j() {
				!a && r && n && (window.requestAnimationFrame(v), n = !1);
			}
			function D() {
				a = !0;
			}
			...
			function G(m, S) {
				var o;
				for (o = 0; o < s; o += 1) e[o].animation.setVolume(m, S);
			}
			function R(m) {
				var S;
				for (S = 0; S < s; S += 1) e[S].animation.mute(m);
			}
			function F(m) {
				var S;
				for (S = 0; S < s; S += 1) e[S].animation.unmute(m);
			}
			...
			var s = 4, r = .001, n = 1e-7, a = 10, u = 11, h = 1 / (u - 1), d = typeof Float32Array == "function";
			function g(v, p) {
				return 1 - 3 * p + 3 * v;
			}
			function E(v, p) {
			...
			function y(v) {
				this._p = v, this._mSampleValues = d ? new Float32Array(u) : new Array(u), this._precomputed = !1, this.get = this.get.bind(this);
			}
			return y.prototype = {
				get: function(p) {
				...
				_precompute: function() {
					...
					this._precomputed = !0, (p !== c || b !== P) && this._calcSampleValues();
				},
			...
			function t() {
				return {
					addedLength: 0,
					percents: ht("float32", _e()),
					lengths: ht("float32", _e())
				};
			}
			return We(8, t);
		}(), Hi = function() {
		...
		function Gs() {
			...
			function h(l, _) {
				...
				for (var c = w[y] > v ? -1 : 1, b = !0; b;) if (w[y] <= v && w[y + 1] > v ? (p = (v - w[y]) / (w[y + 1] - w[y]), b = !1) : y += c, y < 0 || y >= C - 1) {
					if (y === C - 1) return k[y];
					b = !1;
				}
			...
			function d(l, _, k, w, C, y) {
				var v = h(C, y), p = 1 - v;
				return [t.round((p * p * p * l[0] + (v * p * p + p * v * p + p * p * v) * k[0] + (v * v * p + p * v * v + v * p * v) * w[0] + v * v * v * _[0]) * 1e3) / 1e3, t.round((p * p * p * l[1] + (v * p * p + p * v * p + p * p * v) * k[1] + (v * v * p + p * v * v + v * p * v) * w[1] + v * v * v * _[1]) * 1e3) / 1e3];
			}
			var g = ht("float32", 8);
			function E(l, _, k, w, C, y, v) {
				...
				var p = h(C, v);
				y = y > 1 ? 1 : y;
				var c = h(y, v), b, P = l.length, x = 1 - p, T = 1 - c, I = x * x * x, j = p * x * x * 3, D = p * p * x * 3, L = p * p * p, G = x * x * T, R = p * x * T + x * p * T + x * x * c, F = p * p * T + x * p * c + p * x * c, m = p * p * c, S = x * T * T, o = p * T * T + x * c * T + x * T * c, f = p * c * T + x * c * c + p * T * c, M = p * c * c, A = T * T * T, B = c * T * T + T * c * T + T * T * c, q = c * c * T + T * c * c + c * T * c, W = c * c * c;
				for (b = 0; b < P; b += 1) g[b * 4] = t.round((I * l[b] + j * k[b] + D * w[b] + L * _[b]) * 1e3) / 1e3, g[b * 4 + 1] = t.round((G * l[b] + R * k[b] + F * w[b] + m * _[b]) * 1e3) / 1e3, g[b * 4 + 2] = t.round((S * l[b] + o * k[b] + f * w[b] + M * _[b]) * 1e3) / 1e3, g[b * 4 + 3] = t.round((A * l[b] + B * k[b] + q * w[b] + W * _[b]) * 1e3) / 1e3;
				return g;
			}
			return {
				getSegmentsLength: r,
		...
		function Yi(t, e) {
			...
			for (var r = e.lastIndex, n = r, a = this.keyframes.length - 1, u = !0, h, d, g; u;) {
			...
			if (h.to) {
				...
				if (t >= y || t < v) {
					...
					for (w = e.lastFrame < t && e._lastKeyframeIndex === n ? e._lastPoint : 0, u = !0, k = c.points.length; u;) {
		...
		function Zi(t) {
			var e = t[0] * U, i = t[1] * U, s = t[2] * U, r = Math.cos(e / 2), n = Math.cos(i / 2), a = Math.cos(s / 2), u = Math.sin(e / 2), h = Math.sin(i / 2), d = Math.sin(s / 2), g = r * n * a - u * h * d;
			return [
				u * h * a + r * n * d,
				u * n * a + r * h * d,
				r * h * a - u * n * d,
		...
		function Ge(t) {
			var e;
			if (this.propType === "unidimensional") e = t * this.mult, Xi(this.v - e) > 1e-5 && (this.v = e, this._mdf = !0);
			else for (var i = 0, s = this.v.length; i < s;) e = t[i] * this.mult, Xi(this.v[i] - e) > 1e-5 && (this.v[i] = e, this._mdf = !0), i += 1;
		}
		function He() {
		...
		function Ys(t, e, i, s) {
			this.propType = "unidimensional", this.mult = i || 1, this.data = e, this.v = i ? e.k * i : e.k, this.pv = e.k, this._mdf = !1, this.elem = t, this.container = s, this.comp = t.comp, this.k = !1, this.kf = !1, this.vel = 0, this.effectsSequence = [], this._isFirstFrame = !0, this.getValue = He, this.setVValue = Ge, this.addEffect = Xe;
		}
		function Zs(t, e, i, s) {
			...
			this._isFirstFrame = !0, this.effectsSequence = [], this.getValue = He, this.setVValue = Ge, this.addEffect = Xe;
		}
		function Ks(t, e, i, s) {
			...
			}, this.k = !0, this.kf = !0, this.data = e, this.mult = i || 1, this.elem = t, this.container = s, this.comp = t.comp, this.v = ie, this.pv = ie, this._isFirstFrame = !0, this.getValue = He, this.setVValue = Ge, this.interpolateValue = Yi, this.effectsSequence = [Ki.bind(this)], this.addEffect = Xe;
		}
		function Us(t, e, i, s) {
			...
			this.effectsSequence = [Ki.bind(this)], this.data = e, this.keyframes = e.k, this.keyframesMetadata = [], this.offsetTime = t.data.st, this.k = !0, this.kf = !0, this._isFirstFrame = !0, this.mult = i || 1, this.elem = t, this.container = s, this.comp = t.comp, this.getValue = He, this.setVValue = Ge, this.interpolateValue = Yi, this.frameId = -1;
		...
		function zt() {
			this.c = !1, this._length = 0, this._maxLength = 8, this.v = $(this._maxLength), this.o = $(this._maxLength), this.i = $(this._maxLength);
		}
		zt.prototype.setPathData = function(t, e) {
			...
			for (u = r; u < a; u += 1) t.setTripleAt(e[n][0], e[n][1], s[n][0], s[n][1], i[n][0], i[n][1], u, !1), n -= 1;
			return t;
		...
		var fe = function() {
			...
			function e(y, v, p) {
				...
				if (y < R[0].t - this.offsetTime) b = R[0].s[0], x = !0, c = 0;
				else if (y >= R[R.length - 1].t - this.offsetTime) b = R[R.length - 1].s ? R[R.length - 1].s[0] : R[R.length - 2].e[0], x = !0;
				else {
					for (var F = c, m = R.length - 1, S = !0, o, f, M; S && (o = R[F], f = R[F + 1], !(f.t - this.offsetTime > y));) F < m - 1 ? F += 1 : S = !1;
			...
			function r(y, v) {
				if (y._length !== v._length || y.c !== v.c) return !1;
				var p, c = y._length;
				for (p = 0; p < c; p += 1) if (y.v[p][0] !== v.v[p][0] || y.v[p][1] !== v.v[p][1] || y.o[p][0] !== v.o[p][0] || y.o[p][1] !== v.o[p][1] || y.i[p][0] !== v.i[p][0] || y.i[p][1] !== v.i[p][1]) return !1;
				return !0;
			}
			function n(y) {
				r(this.v, y) || (this.v = ft.clone(y), this.localShapeCollection.releaseShapes(), this.localShapeCollection.addShape(this.v), this._mdf = !0, this.paths = this.localShapeCollection);
			}
			function a() {
			...
			function u(y, v, p) {
				this.propType = "shape", this.comp = y.comp, this.container = y, this.elem = y, this.data = v, this.k = !1, this.kf = !1, this._mdf = !1;
			...
			function d(y, v, p) {
				this.propType = "shape", this.comp = y.comp, this.elem = y, this.container = y, this.offsetTime = y.data.st, this.keyframes = p === 3 ? v.pt.k : v.ks.k, this.keyframesMetadata = [], this.k = !0, this.kf = !0;
				var c = this.keyframes[0].s[0].i.length;
				this.v = ft.newElement(), this.v.setPathData(this.keyframes[0].s[0].c, c), this.pv = ft.clone(this.v), this.localShapeCollection = fe.newShapeCollection(), this.paths = this.localShapeCollection, this.paths.addShape(this.v), this.lastFrame = t, this.reset = s, this._caching = {
					lastFrame: t,
					lastIndex: 0
			...
			var g = function() {
				var y = Wt;
				function v(p, c) {
					this.v = ft.newElement(), this.v.setPathData(!0, 4), this.localShapeCollection = fe.newShapeCollection(), this.paths = this.localShapeCollection, this.localShapeCollection.addShape(this.v), this.d = c.d, this.elem = p, this.comp = p.comp, this.frameId = -1, this.initDynamicPropertyContainer(p), this.p = V.getProp(p, c.p, 1, 0, this), this.s = V.getProp(p, c.s, 1, 0, this), this.dynamicProperties.length ? this.k = !0 : (this.k = !1, this.convertEllToPath());
				}
				return v.prototype = {
					reset: s,
					getValue: function() {
				...
				function y(v, p) {
					this.v = ft.newElement(), this.v.setPathData(!0, 0), this.elem = v, this.comp = v.comp, this.data = p, this.frameId = -1, this.d = p.d, this.initDynamicPropertyContainer(v), p.sy === 1 ? (this.ir = V.getProp(v, p.ir, 0, 0, this), this.is = V.getProp(v, p.is, 0, .01, this), this.convertToPath = this.convertStarToPath) : this.convertToPath = this.convertPolygonToPath, this.pt = V.getProp(v, p.pt, 0, 0, this), this.p = V.getProp(v, p.p, 1, 0, this), this.r = V.getProp(v, p.r, 0, U, this), this.or = V.getProp(v, p.or, 0, 0, this), this.os = V.getProp(v, p.os, 0, .01, this), this.localShapeCollection = fe.newShapeCollection(), this.localShapeCollection.addShape(this.v), this.paths = this.localShapeCollection, this.dynamicProperties.length ? this.k = !0 : (this.k = !1, this.convertToPath());
				}
				return y.prototype = {
					reset: s,
					getValue: function() {
					...
					convertStarToPath: function() {
						var p = Math.floor(this.pt.v) * 2, c = Math.PI * 2 / p, b = !0, P = this.or.v, x = this.ir.v, T = this.os.v, I = this.is.v, j = 2 * Math.PI * P / (p * 2), D = 2 * Math.PI * x / (p * 2), L, G, R, F, m = -Math.PI / 2;
						m += this.r.v;
						var S = this.data.d === 3 ? -1 : 1;
						for (this.v._length = 0, L = 0; L < p; L += 1) {
							G = b ? P : x, R = b ? T : I, F = b ? j : D;
							var o = G * Math.cos(m), f = G * Math.sin(m), M = o === 0 && f === 0 ? 0 : f / Math.sqrt(o * o + f * f), A = o === 0 && f === 0 ? 0 : -o / Math.sqrt(o * o + f * f);
							o += +this.p.v[0], f += +this.p.v[1], this.v.setTripleAt(o, f, o - M * F * R * S, f - A * F * R * S, o + M * F * R * S, f + A * F * R * S, L, !0), b = !b, m += c * S;
						}
					},
					convertPolygonToPath: function() {
						var p = Math.floor(this.pt.v), c = Math.PI * 2 / p, b = this.or.v, P = this.os.v, x = 2 * Math.PI * b / (p * 4), T, I = -Math.PI * .5, j = this.data.d === 3 ? -1 : 1;
						for (I += this.r.v, this.v._length = 0, T = 0; T < p; T += 1) {
							...
							D += +this.p.v[0], L += +this.p.v[1], this.v.setTripleAt(D, L, D - G * x * P * j, L - R * x * P * j, D + G * x * P * j, L + R * x * P * j, T, !0), I += c * j;
						}
				...
				function y(v, p) {
					this.v = ft.newElement(), this.v.c = !0, this.localShapeCollection = fe.newShapeCollection(), this.localShapeCollection.addShape(this.v), this.paths = this.localShapeCollection, this.elem = v, this.comp = v.comp, this.frameId = -1, this.d = p.d, this.initDynamicPropertyContainer(v), this.p = V.getProp(v, p.p, 1, 0, this), this.s = V.getProp(v, p.s, 1, 0, this), this.r = V.getProp(v, p.r, 0, 0, this), this.dynamicProperties.length ? this.k = !0 : (this.k = !1, this.convertRectToPath());
				}
				return y.prototype = {
					convertRectToPath: function() {
						var p = this.p.v[0], c = this.p.v[1], b = this.s.v[0] / 2, P = this.s.v[1] / 2, x = be(b, P, this.r.v), T = x * (1 - Wt);
						this.v._length = 0, this.d === 2 || this.d === 1 ? (this.v.setTripleAt(p + b, c - P + x, p + b, c - P + x, p + b, c - P + T, 0, !0), this.v.setTripleAt(p + b, c + P - x, p + b, c + P - T, p + b, c + P - x, 1, !0), x !== 0 ? (this.v.setTripleAt(p + b - x, c + P, p + b - x, c + P, p + b - T, c + P, 2, !0), this.v.setTripleAt(p - b + x, c + P, p - b + T, c + P, p - b + x, c + P, 3, !0), this.v.setTripleAt(p - b, c + P - x, p - b, c + P - x, p - b, c + P - T, 4, !0), this.v.setTripleAt(p - b, c - P + x, p - b, c - P + T, p - b, c - P + x, 5, !0), this.v.setTripleAt(p - b + x, c - P, p - b + x, c - P, p - b + T, c - P, 6, !0), this.v.setTripleAt(p + b - x, c - P, p + b - T, c - P, p + b - x, c - P, 7, !0)) : (this.v.setTripleAt(p - b, c + P, p - b + T, c + P, p - b, c + P, 2), this.v.setTripleAt(p - b, c - P, p - b, c - P + T, p - b, c - P, 3))) : (this.v.setTripleAt(p + b, c - P + x, p + b, c - P + T, p + b, c - P + x, 0, !0), x !== 0 ? (this.v.setTripleAt(p + b - x, c - P, p + b - x, c - P, p + b - T, c - P, 1, !0), this.v.setTripleAt(p - b + x, c - P, p - b + T, c - P, p - b + x, c - P, 2, !0), this.v.setTripleAt(p - b, c - P + x, p - b, c - P + x, p - b, c - P + T, 3, !0), this.v.setTripleAt(p - b, c + P - x, p - b, c + P - T, p - b, c + P - x, 4, !0), this.v.setTripleAt(p - b + x, c + P, p - b + x, c + P, p - b + T, c + P, 5, !0), this.v.setTripleAt(p + b - x, c + P, p + b - T, c + P, p + b - x, c + P, 6, !0), this.v.setTripleAt(p + b, c + P - x, p + b, c + P - x, p + b, c + P - T, 7, !0)) : (this.v.setTripleAt(p - b, c - P, p - b + T, c - P, p - b, c - P, 1, !0), this.v.setTripleAt(p - b, c + P, p - b, c + P - T, p - b, c + P, 2, !0), this.v.setTripleAt(p + b, c + P, p + b - T, c + P, p + b, c + P, 3, !0)));
					},
					getValue: function() {
			...
			function _(y, v, p) {
				var c;
				if (p === 3 || p === 4) (p === 3 ? v.pt : v.ks).k.length ? c = new d(y, v, p) : c = new u(y, v, p);
		...
		var st = function() {
			...
			function w(o, f, M, A, B, q, W, X, Y, it, mt, Bt, gt, lt, kt, K) {
				var z = this.props;
				if (o === 1 && f === 0 && M === 0 && A === 0 && B === 0 && q === 1 && W === 0 && X === 0 && Y === 0 && it === 0 && mt === 1 && Bt === 0) return z[12] = z[12] * o + z[15] * gt, z[13] = z[13] * q + z[15] * lt, z[14] = z[14] * mt + z[15] * kt, z[15] *= K, this._identityCalculated = !1, this;
			...
			function v(o) {
				for (var f = 0; f < 16;) {
					if (o.props[f] !== this.props[f]) return !1;
					f += 1;
				}
				return !0;
			}
			...
			function b(o, f, M) {
				return {
					x: o * this.props[0] + f * this.props[4] + M * this.props[8] + this.props[12],
					y: o * this.props[1] + f * this.props[5] + M * this.props[9] + this.props[13],
					z: o * this.props[2] + f * this.props[6] + M * this.props[10] + this.props[14]
				};
			}
			function P(o, f, M) {
			...
			function j(o) {
				return this.getInverseMatrix().applyToPointArray(o[0], o[1], o[2] || 0);
			}
			function D(o) {
				var f, M = o.length, A = [];
			...
			function G(o, f, M) {
				...
				return this.isIdentity() ? A = [
					...
					o * this.props[0] + f * this.props[4] + M * this.props[8] + this.props[12],
					o * this.props[1] + f * this.props[5] + M * this.props[9] + this.props[13],
					o * this.props[2] + f * this.props[6] + M * this.props[10] + this.props[14]
				], A;
			}
			function R(o, f) {
			...
			function S() {
				var o = this.props, f = m(o[0]), M = m(o[1]), A = m(o[4]), B = m(o[5]), q = m(o[12]), W = m(o[13]);
		...
		function rr(t) {
			switch (t) {
				case "propertyFactory": return V;
				case "shapePropertyFactory": return Ye;
				case "matrix": return st;
				default: return null;
			}
		}
		...
		var $i = "";
		var ts = document.getElementsByTagName("script"), es = ts[ts.length - 1] || { src: "" };
		...
		function Pt() {}
		Pt.prototype.initModifierProperties = function() {}, Pt.prototype.addShapeToModifier = function() {}, Pt.prototype.addShape = function(t) {
			if (!this.closed) {
				t.sh.container.addDynamicProperty(t.sh);
				var e = {
					shape: t.sh,
					data: t,
					localShapeCollection: fe.newShapeCollection()
				};
		...
		H([Pt], Et), Et.prototype.initModifierProperties = function(t, e) {
			this.s = V.getProp(t, e.s, 0, .01, this), this.e = V.getProp(t, e.e, 0, .01, this), this.o = V.getProp(t, e.o, 0, 0, this), this.sValue = 0, this.eValue = 0, this.getValue = this.processKeys, this.m = e.m, this._isAnimated = !!this.s.effectsSequence.length || !!this.e.effectsSequence.length || !!this.o.effectsSequence.length;
			...
			if (i === e) for (a = 0; a < u; a += 1) this.shapes[a].localShapeCollection.releaseShapes(), this.shapes[a].shape._mdf = !0, this.shapes[a].shape.paths = this.shapes[a].localShapeCollection, this._mdf && (this.shapes[a].pathsData.length = 0);
			else if (i === 1 && e === 0 || i === 0 && e === 1) {
				if (this._mdf) for (a = 0; a < u; a += 1) this.shapes[a].pathsData.length = 0, this.shapes[a].shape._mdf = !0;
			} else {
				var k = [], w, C;
				...
				for (a = u - 1; a >= 0; a -= 1) if (w = this.shapes[a], w.shape._mdf) {
					for (C = w.localShapeCollection, C.releaseShapes(), this.m === 2 && u > 1 ? (c = this.calculateShapeEdges(e, i, w.totalShapeLength, p, _), p += w.totalShapeLength) : c = [[y, v]], d = c.length, h = 0; h < d; h += 1) {
						y = c[h][0], v = c[h][1], k.length = 0, v <= 1 ? k.push({
							s: w.totalShapeLength * y,
							e: w.totalShapeLength * v
						}) : y >= 1 ? k.push({
							s: w.totalShapeLength * (y - 1),
							e: w.totalShapeLength * (v - 1)
						}) : (k.push({
							s: w.totalShapeLength * y,
						...
						if (k[0].s !== k[0].e) {
							if (k.length > 1) if (w.shape.paths.shapes[w.shape.paths._length - 1].c) {
								var x = b.pop();
			...
			var s = t.pathsData, r = t.shape.paths.shapes, n, a = t.shape.paths._length, u, h, d = 0, g, E, l, _, k = [], w, C = !0;
			for (i ? (E = i._length, w = i._length) : (i = ft.newElement(), E = 0, w = 0), k.push(i), n = 0; n < a; n += 1) {
				for (l = s[n].lengths, i.c = r[n].c, h = r[n].c ? l.length : l.length + 1, u = 1; u < h; u += 1) if (g = l[u - 1], d + g.addedLength < e.s) d += g.addedLength, i.c = !1;
				else if (d > e.e) {
					i.c = !1;
					break;
				} else e.s <= d && e.e >= d + g.addedLength ? (this.addSegment(r[n].v[u - 1], r[n].o[u - 1], r[n].i[u], r[n].v[u], i, E, C), C = !1) : (_ = Mt.getNewSegment(r[n].v[u - 1], r[n].v[u], r[n].o[u - 1], r[n].i[u], (e.s - d) / g.addedLength, (e.e - d) / g.addedLength, l[u - 1]), this.addSegmentFromArray(_, i, E, C), C = !1, i.c = !1), d += g.addedLength, E += 1;
				if (r[n].c && l.length) {
					if (g = l[u - 1], d <= e.e) {
						var y = l[u - 1].addedLength;
						e.s <= d && e.e >= d + y ? (this.addSegment(r[n].v[u - 1], r[n].o[u - 1], r[n].i[0], r[n].v[0], i, E, C), C = !1) : (_ = Mt.getNewSegment(r[n].v[u - 1], r[n].v[0], r[n].o[u - 1], r[n].i[0], (e.s - d) / y, (e.e - d) / y, l[u - 1]), this.addSegmentFromArray(_, i, E, C), C = !1, i.c = !1);
					} else i.c = !1;
					d += g.addedLength, E += 1;
				}
				if (i._length && (i.setXYAt(i.v[w][0], i.v[w][1], "i", w), i.setXYAt(i.v[i._length - 1][0], i.v[i._length - 1][1], "o", i._length - 1)), d > e.e) break;
				n < a - 1 && (i = ft.newElement(), C = !0, k.push(i), E = 0);
			}
			return k;
		};
		function Ee() {}
		H([Pt], Ee), Ee.prototype.initModifierProperties = function(t, e) {
			...
			if (a !== 0) {
				var u, h;
				for (i = 0; i < s; i += 1) {
					if (u = this.shapes[i], h = u.localShapeCollection, !(!u.shape._mdf && !this._mdf && !t)) for (h.releaseShapes(), u.shape._mdf = !0, e = u.shape.paths.shapes, n = u.shape.paths._length, r = 0; r < n; r += 1) h.addShape(this.processPath(e[r], a));
		...
		var ci = function() {
			...
			function a(h, d, g) {
				if (this.elem = h, this.frameId = -1, this.propType = "transform", this.data = d, this.v = new st(), this.pre = new st(), this.appliedTransformations = 0, this.initDynamicPropertyContainer(g || h), d.p && d.p.s ? (this.px = V.getProp(h, d.p.x, 0, 0, this), this.py = V.getProp(h, d.p.y, 0, 0, this), d.p.z && (this.pz = V.getProp(h, d.p.z, 0, 0, this))) : this.p = V.getProp(h, d.p || { k: [
					...
					this.or = V.getProp(h, d.or, 1, U, this), this.or.sh = !0;
				} else this.r = V.getProp(h, d.r || { k: 0 }, 0, U, this);
				d.sk && (this.sk = V.getProp(h, d.sk, 0, U, this), this.sa = V.getProp(h, d.sa, 0, U, this)), this.a = V.getProp(h, d.a || { k: [
					0,
					0,
					0
				] }, 1, 0, this), this.s = V.getProp(h, d.s || { k: [
					100,
					100,
					100
				] }, 1, .01, this), d.o ? this.o = V.getProp(h, d.o, 0, .01, h) : this.o = {
					_mdf: !1,
					v: 1
			...
			a.prototype = {
				...
				autoOrient: r
			}, H([ot], a), a.prototype.addDynamicProperty = n, a.prototype._addDynamicProperty = ot.prototype.addDynamicProperty;
			function u(h, d, g) {
				return new a(h, d, g);
			}
		...
		H([Pt], Tt), Tt.prototype.initModifierProperties = function(t, e) {
			this.getValue = this.processKeys, this.c = V.getProp(t, e.c, 0, null, this), this.o = V.getProp(t, e.o, 0, null, this), this.tr = ci.getTransformProperty(t, e.tr, this), this.so = V.getProp(t, e.tr.so, 0, .01, this), this.eo = V.getProp(t, e.tr.eo, 0, .01, this), this.data = e, this.dynamicProperties.length || this.getValue(!0), this._isAnimated = !!this.dynamicProperties.length, this.pMatrix = new st(), this.rMatrix = new st(), this.sMatrix = new st(), this.tMatrix = new st(), this.matrix = new st();
			...
			if (this._mdf || t) {
				...
				var v = 0;
				if (l > 0) {
					for (; v < k;) this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, 1, !1), v += 1;
					_ && (this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, _, !1), v += _);
				} else if (l < 0) {
					for (; v > k;) this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, 1, !0), v -= 1;
					_ && (this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, -_, !0), v -= _);
				}
				s = this.data.m === 1 ? 0 : this._currentCopies - 1, r = this.data.m === 1 ? 1 : -1, n = this._currentCopies;
				for (var p, c; n;) {
					if (e = this.elemsData[s].it, i = e[e.length - 1].transform.mProps.v.props, c = i.length, e[e.length - 1].transform.mProps._mdf = !0, e[e.length - 1].transform.op._mdf = !0, e[e.length - 1].transform.op.v = this._currentCopies === 1 ? this.so.v : this.so.v + (this.eo.v - this.so.v) * (s / (this._currentCopies - 1)), v !== 0) {
						for ((s !== 0 && r === 1 || s !== this._currentCopies - 1 && r === -1) && this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, 1, !1), this.matrix.transform(C[0], C[1], C[2], C[3], C[4], C[5], C[6], C[7], C[8], C[9], C[10], C[11], C[12], C[13], C[14], C[15]), this.matrix.transform(y[0], y[1], y[2], y[3], y[4], y[5], y[6], y[7], y[8], y[9], y[10], y[11], y[12], y[13], y[14], y[15]), this.matrix.transform(w[0], w[1], w[2], w[3], w[4], w[5], w[6], w[7], w[8], w[9], w[10], w[11], w[12], w[13], w[14], w[15]), p = 0; p < c; p += 1) i[p] = this.matrix.props[p];
						this.matrix.reset();
					} else for (this.matrix.reset(), p = 0; p < c; p += 1) i[p] = this.matrix.props[p];
					v += 1, n -= 1, s += r;
				}
			} else for (n = this._currentCopies, s = 0, r = 1; n;) e = this.elemsData[s].it, i = e[e.length - 1].transform.mProps.v.props, e[e.length - 1].transform.mProps._mdf = !1, e[e.length - 1].transform.op._mdf = !1, n -= 1, s += r;
			return a;
		...
		tt.prototype.point = function(t) {
			...
			return [new tt(this.points[0], e, r, a, !0), new tt(a, n, s, this.points[3], !0)];
		};
		function ns(t, e) {
		...
		tt.prototype.intersections = function(t, e, i) {
			...
			var i = (e + 1) % t.length();
			return new tt(t.v[e], t.o[e], t.i[i], t.v[i], !0);
		}, tt.shapeSegmentInverted = function(t, e) {
			var i = (e + 1) % t.length();
			return new tt(t.v[i], t.i[i], t.o[e], t.v[e], !0);
		};
		function vi(t, e) {
			return [
				t[1] * e[2] - t[2] * e[1],
		...
		function cr(t, e, i, s, r, n) {
			for (var a = 0; a < s; a += 1) {
				var u = (a + 1) / (s + 1), h = r === 2 ? Math.sqrt(Math.pow(e.points[3][0] - e.points[0][0], 2) + Math.pow(e.points[3][1] - e.points[0][1], 2)) : 0, d = e.normalAngle(u);
				hs(t, e.point(u), d, n, i, h / ((s + 1) * 2), h / ((s + 1) * 2)), n = -n;
			}
			return n;
		}
		xe.prototype.processPath = function(t, e, i, s) {
			...
			if (a !== 0) {
				var d, g;
				for (i = 0; i < s; i += 1) {
					if (d = this.shapes[i], g = d.localShapeCollection, !(!d.shape._mdf && !this._mdf && !t)) for (g.releaseShapes(), d.shape._mdf = !0, e = d.shape.paths.shapes, n = d.shape.paths._length, r = 0; r < n; r += 1) g.addShape(this.processPath(e[r], a, u, h));
		...
		function ce(t, e) {
			var i, s, r, n, a, u, h = gi(t.points[0], t.points[1], e);
			i = h[0], s = h[1], h = gi(t.points[1], t.points[2], e), r = h[0], n = h[1], h = gi(t.points[2], t.points[3], e), a = h[0], u = h[1];
			var d = Qe(i, s, r, n);
			d === null && (d = s);
			var g = Qe(a, u, r, n);
		...
		function ls(t, e, i, s, r) {
			...
			var k = Qe(ue(n, e.points[2]) ? e.points[0] : e.points[2], n, a, ue(a, i.points[1]) ? i.points[3] : i.points[1]);
		...
		function us(t, e) {
			...
			n = t.split(i[0]), s = n[0];
			var u = (i[1] - i[0]) / (1 - i[0]);
			return n = n[1].split(u), a = n[0], r = n[1], [
				ce(s, e),
				ce(a, e),
				ce(r, e)
			];
		...
		H([Pt], Me), Me.prototype.initModifierProperties = function(t, e) {
			...
			if (a !== 0) {
				var d, g;
				for (i = 0; i < s; i += 1) {
					if (d = this.shapes[i], g = d.localShapeCollection, !(!d.shape._mdf && !this._mdf && !t)) for (g.releaseShapes(), d.shape._mdf = !0, e = d.shape.paths.shapes, n = d.shape.paths._length, r = 0; r < n; r += 1) g.addShape(this.processPath(e[r], a, h, u));
					d.shape.paths = d.localShapeCollection;
				}
			}
			this.dynamicProperties.length || (this._mdf = !1);
		...
		var re = function() {
			...
			var s = 127988, r = 917631, n = 917601, a = 917626, u = 65039, h = 8205, d = 127462, g = 127487, E = [
				"d83cdffb",
				"d83cdffc",
				"d83cdffd",
				"d83cdffe",
			...
			function l(m) {
				var S = m.split(","), o, f = S.length, M = [];
				for (o = 0; o < f; o += 1) S[o] !== "sans-serif" && S[o] !== "monospace" && M.push(S[o]);
				return M.join(",");
			}
			function _(m, S) {
				var o = at("span");
				o.setAttribute("aria-hidden", !0), o.style.fontFamily = S;
				var f = at("span");
				...
				var M = f.offsetWidth;
				return f.style.fontFamily = l(m) + ", " + S, {
					node: f,
					w: M,
					parent: o
				};
			...
			function k() {
				var m, S = this.fonts.length, o, f, M = S;
				for (m = 0; m < S; m += 1) this.fonts[m].loaded ? M -= 1 : this.fonts[m].fOrigin === "n" || this.fonts[m].origin === 0 ? this.fonts[m].loaded = !0 : (o = this.fonts[m].monoCase.node, f = this.fonts[m].monoCase.w, o.offsetWidth !== f ? (M -= 1, this.fonts[m].loaded = !0) : (o = this.fonts[m].sansCase.node, f = this.fonts[m].sansCase.w, o.offsetWidth !== f && (M -= 1, this.fonts[m].loaded = !0)), this.fonts[m].loaded && (this.fonts[m].sansCase.parent.parentNode.removeChild(this.fonts[m].sansCase.parent), this.fonts[m].monoCase.parent.parentNode.removeChild(this.fonts[m].monoCase.parent)));
				M !== 0 && Date.now() - this.initTime < t ? setTimeout(this.checkLoadedFontsBinded, 20) : setTimeout(this.setIsLoadedBinded, 10);
			}
			function w(m, S) {
				var o = document.body && S ? "svg" : "canvas", f, M = cs(m);
				if (o === "svg") {
					var A = O("text");
					A.style.fontSize = "100px", A.setAttribute("font-family", m.fFamily), A.setAttribute("font-style", M.style), A.setAttribute("font-weight", M.weight), A.textContent = "1", m.fClass ? (A.style.fontFamily = "inherit", A.setAttribute("class", m.fClass)) : A.style.fontFamily = m.fFamily, S.appendChild(A), f = A;
				} else {
					var B = new OffscreenCanvas(500, 500).getContext("2d");
					B.font = M.style + " " + M.weight + " 100px " + m.fFamily, f = B;
				}
				function q(W) {
			...
			function C(m, S) {
				...
				var o = m.list, f, M = o.length, A = M;
				for (f = 0; f < M; f += 1) {
					var B = !0, q, W;
					if (o[f].loaded = !1, o[f].monoCase = _(o[f].fFamily, "monospace"), o[f].sansCase = _(o[f].fFamily, "sans-serif"), !o[f].fPath) o[f].loaded = !0, A -= 1;
					else if (o[f].fOrigin === "p" || o[f].origin === 3) {
						if (q = document.querySelectorAll("style[f-forigin=\"p\"][f-family=\"" + o[f].fFamily + "\"], style[f-origin=\"3\"][f-family=\"" + o[f].fFamily + "\"]"), q.length > 0 && (B = !1), B) {
							var X = at("style");
						...
						for (q = document.querySelectorAll("link[f-forigin=\"g\"], link[f-origin=\"1\"]"), W = 0; W < q.length; W += 1) q[W].href.indexOf(o[f].fPath) !== -1 && (B = !1);
						if (B) {
							var Y = at("link");
						...
						for (q = document.querySelectorAll("script[f-forigin=\"t\"], script[f-origin=\"2\"]"), W = 0; W < q.length; W += 1) o[f].fPath === q[W].src && (B = !1);
						if (B) {
							var it = at("link");
			...
			function y(m) {
				if (m) {
					...
					var S, o = m.length, f, M = this.chars.length, A;
					for (S = 0; S < o; S += 1) {
						for (f = 0, A = !1; f < M;) this.chars[f].style === m[S].style && this.chars[f].fFamily === m[S].fFamily && this.chars[f].ch === m[S].ch && (A = !0), f += 1;
						A || (this.chars.push(m[S]), M += 1);
					}
				}
			}
			function v(m, S, o) {
				for (var f = 0, M = this.chars.length; f < M;) {
					if (this.chars[f].ch === m && this.chars[f].style === S && this.chars[f].fFamily === o) return this.chars[f];
					f += 1;
				}
				return (typeof m == "string" && m.charCodeAt(0) !== 13 || !m) && console && console.warn && !this._warned && (this._warned = !0, console.warn("Missing character from exported characters list: ", m, S, o)), e;
			}
			function p(m, S, o) {
				var f = this.getFontByName(S), M = m;
				if (!f.cache[M]) {
					var A = f.helper;
					if (m === " ") {
						var B = A.measureText("|" + m + "|"), q = A.measureText("||");
						f.cache[M] = (B - q) / 100;
					} else f.cache[M] = A.measureText(m) / 100;
				}
				return f.cache[M] * o;
			}
			function c(m) {
				for (var S = 0, o = this.fonts.length; S < o;) {
					if (this.fonts[S].fName === m) return this.fonts[S];
					S += 1;
				}
				return this.fonts[0];
			}
			function b(m) {
				var S = 0, o = m.charCodeAt(0);
				if (o >= 55296 && o <= 56319) {
					var f = m.charCodeAt(1);
					f >= 56320 && f <= 57343 && (S = (o - 55296) * 1024 + f - 56320 + 65536);
				}
				return S;
			}
			function P(m, S) {
				var o = m.toString(16) + S.toString(16);
			...
			function j(m) {
				return I(m.substr(0, 2)) && I(m.substr(2, 2));
			}
			function D(m) {
				return i.indexOf(m) !== -1;
			}
			function L(m, S) {
				var o = b(m.substr(S, 2));
				if (o !== s) return !1;
				var f = 0;
				for (S += 2; f < 5;) {
					if (o = b(m.substr(S, 2)), o < n || o > a) return !1;
					f += 1, S += 2;
				}
				return b(m.substr(S, 2)) === r;
			}
			function G() {
				this.isLoaded = !0;
			}
		...
		wt.prototype = {
			...
			prepareProperties: function(e, i) {
				...
				for (s = 0; s < r; s += 1) (i || this._isParent && this.dynamicProperties[s].propType === "transform") && (this.dynamicProperties[s].getValue(), this.dynamicProperties[s]._mdf && (this.globalData._mdf = !0, this._mdf = !0));
			},
			addDynamicProperty: function(e) {
		...
		Yt.prototype.prepareFrame = function() {}, H([
			de,
			_t,
			wt
		], Yt), Yt.prototype.getBaseElement = function() {
			return null;
		}, Yt.prototype.renderFrame = function() {}, Yt.prototype.destroy = function() {}, Yt.prototype.initExpressions = function() {}, Yt.prototype.getFootageData = function() {
		...
		function vt(t, e, i) {
			...
			this.audio = this.globalData.audioController.createAudio(s), this._currentTime = 0, this.globalData.audioController.addAudio(this), this._volumeMultiplier = 1, this._volume = 1, this._previousVolume = null, this.tm = t.tm ? V.getProp(this, t.tm, 0, e.frameRate, this) : { _placeholder: !0 }, this.lv = V.getProp(this, t.au && t.au.lv ? t.au.lv : { k: [100] }, 1, .01, this);
		}
		vt.prototype.prepareFrame = function(t) {
			...
			_t,
			wt
		], vt), vt.prototype.renderFrame = function() {
			this.isInRange && this._canPlay && (this._isPlaying ? (!this.audio.playing() || Math.abs(this._currentTime / this.globalData.frameRate - this.audio.seek()) > .1) && this.audio.seek(this._currentTime / this.globalData.frameRate) : (this.audio.play(), this.audio.seek(this._currentTime / this.globalData.frameRate), this._isPlaying = !0));
		}, vt.prototype.show = function() {}, vt.prototype.hide = function() {
			...
			return null;
		}, vt.prototype.destroy = function() {}, vt.prototype.sourceRectAtTime = function() {}, vt.prototype.initExpressions = function() {};
		function rt() {}
		rt.prototype.checkLayers = function(t) {
			...
			for (var s = this.elements, r = this.layers, n = 0, a = r.length; n < a;) r[n].ind == e && (!s[n] || s[n] === !0 ? (this.buildItem(n), this.addPendingElement(t)) : (i.push(s[n]), s[n].setAsParent(), r[n].parent !== void 0 ? this.buildElementParenting(t, r[n].parent, i) : t.setHierarchy(i))), n += 1;
		...
		Ft.prototype = {
			initTransform: function() {
				var e = new st();
				this.finalTransform = {
					mProp: this.data.ks ? ci.getTransformProperty(this, this.data.ks, this) : { o: 0 },
					_matMdf: !1,
					_localMatMdf: !1,
					_opMdf: !1,
					mat: e,
			...
			renderLocalTransform: function() {
				if (this.localTransforms) {
					...
					if (this.finalTransform._opMdf) {
						...
						for (e = 0; e < i; e += 1) n *= this.localTransforms[e].opacity * .01;
			...
			globalToLocal: function(e) {
				...
				for (var s = !0, r = this.comp; s;) r.finalTransform ? (r.data.hasMask && i.splice(0, 0, r.finalTransform), r = r.comp) : s = !1;
				var n, a = i.length, u;
				for (n = 0; n < a; n += 1) u = i[n].mat.applyToPointArray(0, 0, 0), e = [
					e[0] - u[0],
					e[1] - u[1],
					0
				];
		...
		function Zt(t, e, i) {
			...
			for (r = 0; r < n; r += 1) if ((u[r].mode !== "a" && u[r].mode !== "n" || u[r].inv || u[r].o.k !== 100 || u[r].o.x) && (y = "mask", v = "mask"), (u[r].mode === "s" || u[r].mode === "i") && h === 0 ? (_ = O("rect"), _.setAttribute("fill", "#ffffff"), _.setAttribute("width", this.element.comp.data.w || 0), _.setAttribute("height", this.element.comp.data.h || 0), d.push(_)) : _ = null, a = O("path"), u[r].mode === "n") this.viewData[r] = {
				op: V.getProp(this.element, u[r].o, 0, .01, this.element),
				prop: Ye.getShapeProp(this.element, u[r], 3),
				elem: a,
				lastPath: ""
			}, s.appendChild(a);
			else {
		...
		var Fe = function() {
			...
			function e(s, r) {
				var n = O("filter");
				return n.setAttribute("id", s), r !== !0 && (n.setAttribute("filterUnits", "objectBoundingBox"), n.setAttribute("x", "0%"), n.setAttribute("y", "0%"), n.setAttribute("width", "100%"), n.setAttribute("height", "100%")), n;
			}
			function i() {
		...
		function bi(t) {
			var e, i = "SourceGraphic", s = t.data.ef ? t.data.ef.length : 0, r = dt(), n = Fe.createFilter(r, !0), a = 0;
			this.filters = [];
			var u;
			for (e = 0; e < s; e += 1) {
				u = null;
		...
		ve.prototype = {
			...
			createContainerElements: function() {
				this.matteElement = O("g"), this.transformedElement = this.layerElement, this.maskedElement = this.layerElement, this._sizeChanged = !1;
				var e = null;
				if (this.data.td) {
					this.matteMasks = {};
					var i = O("g");
		...
		H([
			...
			wt,
			ne
		], me), me.prototype.createContent = function() {
		...
		function _s(t, e) {
			this.data = t, this.type = t.ty, this.d = "", this.lvl = e, this._mdf = !1, this.closed = t.hd === !0, this.pElem = O("path"), this.msElem = null;
		}
		_s.prototype.reset = function() {
			this.d = "", this._mdf = !1;
		};
		function ti(t, e, i, s) {
			this.elem = t, this.frameId = -1, this.dataProps = $(e.length), this.renderer = i, this.k = !1, this.dashStr = "", this.dashArray = ht("float32", e.length ? e.length - 1 : 0), this.dashoffset = ht("float32", 1), this.initDynamicPropertyContainer(s);
			var r, n = e.length || 0, a;
			for (r = 0; r < n; r += 1) a = V.getProp(t, e[r].v, 0, 0, this), this.k = a.k || this.k, this.dataProps[r] = {
				n: e[r].n,
				p: a
			};
		...
		function ws(t, e, i) {
			this.initDynamicPropertyContainer(t), this.getValue = this.iterateDynamicProperties, this.o = V.getProp(t, e.o, 0, .01, this), this.w = V.getProp(t, e.w, 0, null, this), this.d = new ti(t, e.d || {}, "svg", this), this.c = V.getProp(t, e.c, 1, 255, this), this.style = i, this._isAnimated = !!this._isAnimated;
		}
		H([ot], ws);
		function Ss(t, e, i) {
			this.initDynamicPropertyContainer(t), this.getValue = this.iterateDynamicProperties, this.o = V.getProp(t, e.o, 0, .01, this), this.c = V.getProp(t, e.c, 1, 255, this), this.style = i;
		}
		H([ot], Ss);
		function ks(t, e, i) {
		...
		function Ie(t, e, i) {
			...
			this.o = ht("float32", s), this._cmdf = !1, this._omdf = !1, this._collapsable = this.checkCollapsable(), this._hasOpacity = s, this.initDynamicPropertyContainer(i), this.prop = V.getProp(t, e.k, 1, null, this), this.k = this.prop.k, this.getValue(!0);
		}
		Ie.prototype.comparePoints = function(t, e) {
			for (var i = 0, s = this.o.length / 2, r; i < s;) {
				if (r = Math.abs(t[i * 4] - t[e * 4 + i * 2]), r > .01) return !1;
				i += 1;
			}
			return !0;
		...
		ge.prototype.initGradientData = function(t, e, i) {
			this.o = V.getProp(t, e.o, 0, .01, this), this.s = V.getProp(t, e.s, 1, null, this), this.e = V.getProp(t, e.e, 1, null, this), this.h = V.getProp(t, e.h || { k: 0 }, 0, .01, this), this.a = V.getProp(t, e.a || { k: 0 }, 0, U, this), this.g = new Ie(t, e.g, this), this.style = i, this.stops = [], this.setGradientData(i.pElem, e), this.setGradientOpacity(e, i), this._isAnimated = !!this._isAnimated;
		...
		var Es = function(e, i, s, r) {
			...
			function a(E, l, _) {
				...
				for (p = 0; p < c; p += 1) {
					...
					l.styles[p].d += E.hd === !0 ? "" : C, l.styles[p]._mdf = y || l.styles[p]._mdf;
				}
			}
			function u(E, l, _) {
				var k = l.style;
			...
			function d(E, l, _) {
				...
				if (E.t === 1) (l.e._mdf || _) && (k.setAttribute("x2", y[0]), k.setAttribute("y2", y[1]), w && !l.g._collapsable && (l.of.setAttribute("x2", y[0]), l.of.setAttribute("y2", y[1])));
					...
					if ((l.s._mdf || l.e._mdf || _) && (D = Math.sqrt(Math.pow(C[0] - y[0], 2) + Math.pow(C[1] - y[1], 2)), k.setAttribute("r", D), w && !l.g._collapsable && l.of.setAttribute("r", D)), l.e._mdf || l.h._mdf || l.a._mdf || _) {
						...
						G >= 1 ? G = .99 : G <= -1 && (G = -.99);
						var R = D * G, F = Math.cos(L + l.a.v) * R + C[0], m = Math.sin(L + l.a.v) * R + C[1];
						k.setAttribute("fx", F), k.setAttribute("fy", m), w && !l.g._collapsable && (l.of.setAttribute("fx", F), l.of.setAttribute("fy", m));
					}
				}
			}
			function g(E, l, _) {
		...
		H([
			...
			wt,
			ne
		], Q), Q.prototype.initSecondaryElement = function() {}, Q.prototype.identityMatrix = new st(), Q.prototype.buildExpressionInterface = function() {}, Q.prototype.createContent = function() {
			this.searchShapes(this.shapesData, this.itemsData, this.prevViewData, this.layerElement, 0, [], !0), this.filterUniqueShapes();
		}, Q.prototype.filterUniqueShapes = function() {
			var t, e = this.shapes.length, i, s, r = this.stylesList.length, n, a = [], u = !1;
			for (s = 0; s < r; s += 1) {
				for (n = this.stylesList[s], u = !1, a.length = 0, t = 0; t < e; t += 1) i = this.shapes[t], i.styles.indexOf(n) !== -1 && (a.push(i), u = i._isAnimated || u);
			...
			else if (t.ty === "gf" || t.ty === "gs") i = new (t.ty === "gf" ? ge : Ps)(this, t, s), this.globalData.defs.appendChild(i.gf), i.maskId && (this.globalData.defs.appendChild(i.ms), this.globalData.defs.appendChild(i.of), r.setAttribute("mask", "url(" + bt() + "#" + i.maskId + ")"));
			...
			var n = new bs(e, i, Ye.getShapeProp(this, t, s, this));
			...
			for (h = d; h >= 0; h -= 1) {
				if (C = this.searchProcessedElement(t[h]), C ? e[h] = i[C - 1] : t[h]._render = a, t[h].ty === "fl" || t[h].ty === "st" || t[h].ty === "gf" || t[h].ty === "gs" || t[h].ty === "no") C ? e[h].style.closed = !1 : e[h] = this.createStyleElement(t[h], r), t[h]._render && e[h].style.pElem.parentNode !== s && s.appendChild(e[h].style.pElem), l.push(e[h].style);
				else if (t[h].ty === "gr") {
				...
				} else t[h].ty === "tr" ? (C || (e[h] = this.createTransformElement(t[h], s)), k = e[h].transform, u.push(k)) : t[h].ty === "sh" || t[h].ty === "rc" || t[h].ty === "el" || t[h].ty === "sr" ? (C || (e[h] = this.createShapeElement(t[h], u, r)), this.setElementStyles(e[h])) : t[h].ty === "tm" || t[h].ty === "rd" || t[h].ty === "ms" || t[h].ty === "pb" || t[h].ty === "zz" || t[h].ty === "op" ? (C ? (w = e[h], w.closed = !1) : (w = Ht.getModifier(t[h].ty), w.init(this, t[h]), e[h] = w, this.shapeModifiers.push(w)), _.push(w)) : t[h].ty === "rp" && (C ? (w = e[h], w.closed = !0) : (w = Ht.getModifier(t[h].ty), e[h] = w, w.init(this, t, h, e), this.shapeModifiers.push(w), a = !1), _.push(w));
				this.addProcessedElement(t[h], h + 1);
			}
			for (d = l.length, h = 0; h < d; h += 1) l[h].closed = !0;
			for (d = _.length, h = 0; h < d; h += 1) _[h].closed = !0;
		...
		ut.prototype.defaultBoxWidth = [0, 0], ut.prototype.copyData = function(t, e) {
			...
			for (var e = [], i = 0, s = t.length, r, n, a = !1, u = !1, h = ""; i < s;) a = u, u = !1, r = t.charCodeAt(i), h = t.charAt(i), re.isCombinedCharacter(r) ? a = !0 : r >= 55296 && r <= 56319 ? re.isRegionalFlag(t, i) ? h = t.substr(i, 14) : (n = t.charCodeAt(i + 1), n >= 56320 && n <= 57343 && (re.isModifier(r, n) ? (h = t.substr(i, 2), a = !0) : re.isFlagEmoji(t.substr(i, 4)) ? h = t.substr(i, 4) : h = t.substr(i, 2))) : r > 56319 ? (n = t.charCodeAt(i + 1), re.isVariationSelector(r) && (a = !0)) : re.isZeroWidthJoiner(r) && (a = !0, u = !0), a ? (e[e.length - 1] += h, a = !1) : e.push(h), i += h.length;
			return e;
			...
			if (t.sz) for (var T = !0, I = t.sz[0], j = t.sz[1], D, L; T;) {
				L = this.buildFinalText(t.t), D = 0, k = 0, n = L.length, P = t.tr / 1e3 * t.finalSize;
				var G = -1;
				for (r = 0; r < n; r += 1) x = L[r].charCodeAt(0), a = !1, L[r] === " " ? G = r : (x === 13 || x === 3) && (k = 0, a = !0, D += t.finalLineHeight || t.finalSize * 1.2), e.chars ? (p = e.getCharData(L[r], v.fStyle, v.fFamily), c = a ? 0 : p.w * t.finalSize / 100) : c = e.measureText(L[r], t.f, t.finalSize), k + c > I && L[r] !== " " ? (G === -1 ? n += 1 : r = G, D += t.finalLineHeight || t.finalSize * 1.2, L.splice(r, G === r ? 1 : 0, "\r"), G = -1, k = 0) : (k += c, k += P);
				D += v.ascent * t.finalSize / 100, this.canResize && t.finalSize > this.minimumFontSize && j < D ? (t.finalSize -= 1, t.finalLineHeight = t.finalSize * t.lh / t.s) : (t.finalText = L, n = t.finalText.length, T = !1);
			}
			k = -P, c = 0;
			var R = 0, F;
			for (r = 0; r < n; r += 1) if (a = !1, F = t.finalText[r], x = F.charCodeAt(0), x === 13 || x === 3 ? (R = 0, _.push(k), w = k > w ? k : w, k = -2 * P, h = "", a = !0, l += 1) : h = F, e.chars ? (p = e.getCharData(F, v.fStyle, e.getFontByName(t.f).fFamily), c = a ? 0 : p.w * t.finalSize / 100) : c = e.measureText(h, t.f, t.finalSize), F === " " ? R += c + P : (k += c + P + R, R = 0), s.push({
				l: c,
				an: c,
				add: g,
				n: a,
			...
			var f, M, A = [];
			for (C = 0; C < y; C += 1) {
				for (S = m[C], S.a.sc && (t.strokeColorAnim = !0), S.a.sw && (t.strokeWidthAnim = !0), (S.a.fc || S.a.fh || S.a.fs || S.a.fb) && (t.fillColorAnim = !0), M = 0, f = S.s.b, r = 0; r < n; r += 1) o = s[r], o.anIndexes[C] = M, (f == 1 && o.val !== "" || f == 2 && o.val !== "" && o.val !== " " || f == 3 && (o.n || o.val == " " || r == n - 1) || f == 4 && (o.n || r == n - 1)) && (S.s.rn === 1 && A.push(M), M += 1);
		...
		var Mr = function() {
			...
			function s(n, a) {
				this._currentTextLength = -1, this.k = !1, this.data = a, this.elem = n, this.comp = n.comp, this.finalS = 0, this.finalE = 0, this.initDynamicPropertyContainer(n), this.s = V.getProp(n, a.s || { k: 0 }, 0, 0, this), "e" in a ? this.e = V.getProp(n, a.e, 0, 0, this) : this.e = { v: 100 }, this.o = V.getProp(n, a.o || { k: 0 }, 0, 0, this), this.xe = V.getProp(n, a.xe || { k: 0 }, 0, 0, this), this.ne = V.getProp(n, a.ne || { k: 0 }, 0, 0, this), this.sm = V.getProp(n, a.sm || { k: 100 }, 0, 0, this), this.a = V.getProp(n, a.a, 0, .01, this), this.dynamicProperties.length || this.getValue();
			}
			s.prototype = {
				getMult: function(a) {
					...
					if (w === 2) k === _ ? l = a >= k ? 1 : 0 : l = t(0, e(.5 / (k - _) + (a - _) / (k - _), 1)), l = E(l);
					else if (w === 3) k === _ ? l = a >= k ? 0 : 1 : l = 1 - t(0, e(.5 / (k - _) + (a - _) / (k - _), 1)), l = E(l);
					else if (w === 4) k === _ ? l = 0 : (l = t(0, e(.5 / (k - _) + (a - _) / (k - _), 1)), l < .5 ? l *= 2 : l = 1 - 2 * (l - .5)), l = E(l);
					else if (w === 5) {
						if (k === _) l = 0;
						else {
							var C = k - _;
						...
						l = E(l);
					} else w === 6 ? (k === _ ? l = 0 : (a = e(t(0, a + .5 - _), k - _), l = (1 + Math.cos(Math.PI + Math.PI * 2 * a / (k - _))) / 2), l = E(l)) : (a >= i(_) && (a - _ < 0 ? l = t(0, e(e(k, 1) - (_ - a), 1)) : l = t(0, e(k - a, 1))), l = E(l));
					if (this.sm.v !== 100) {
						var p = this.sm.v * .01;
						p === 0 && (p = 1e-8);
						var c = .5 - p * .5;
		...
		function Tr(t, e, i) {
			var s = { propType: !1 }, r = V.getProp, n = e.a;
			this.a = {
				r: n.r ? r(t, n.r, 0, U, i) : s,
				rx: n.rx ? r(t, n.rx, 0, U, i) : s,
				ry: n.ry ? r(t, n.ry, 0, U, i) : s,
				sk: n.sk ? r(t, n.sk, 0, U, i) : s,
				sa: n.sa ? r(t, n.sa, 0, U, i) : s,
			...
			}, this.s = Mr.getTextSelectorProp(t, e.s, i), this.s.t = e.s.t;
		}
		function ae(t, e, i) {
			this._isFirstFrame = !0, this._hasMaskedPath = !1, this._frameId = -1, this._textData = t, this._renderType = e, this._elem = i, this._animatorsData = $(this._textData.a.length), this._pathData = {}, this._moreOptions = { alignment: {} }, this.renderedLetters = [], this.lettersChangedFlag = !1, this.initDynamicPropertyContainer(i);
		}
			...
			if (this.lettersChangedFlag = e, !(!this._mdf && !this._isFirstFrame && !e && (!this._hasMaskedPath || !this._pathData.m._mdf))) {
				...
				if (this._hasMaskedPath) {
					if (D = this._pathData.m, !this._pathData.n || this._pathData._mdf) {
						var L = D.v;
						this._pathData.r.v && (L = L.reverse()), _ = {
							tLength: 0,
							segments: []
						}, E = L._length - 1;
						var G;
					...
					if (_ = this._pathData.pi, k = this._pathData.f.v, p = 0, v = 1, C = 0, y = !0, P = _.segments, k < 0 && D.v.c) for (_.tLength < Math.abs(k) && (k = -Math.abs(k) % _.tLength), p = P.length - 1, b = P[p].points, v = b.length - 1; k < 0;) k += b[v].partialLength, v -= 1, v < 0 && (p -= 1, b = P[p].points, v = b.length - 1);
					b = P[p].points, c = b[v - 1], w = b[v], x = w.partialLength;
				}
				E = l.length, h = 0, d = 0;
				var R = t.finalSize * 1.2 * .714, F = !0, m, S, o, f = s.length, M;
				var A, B = -1, q, W, X, Y = k, it = p, mt = v, Bt = -1, gt, lt, kt, K, z, Dt, Jt, Nt, Rt = "", qt = this.defaultPropsArray, jt;
				if (t.j === 2 || t.j === 1) {
					var yt = 0, Qt = 0, $t = t.j === 2 ? -.5 : -1, Ct = 0, te = !0;
					for (g = 0; g < E; g += 1) if (l[g].n) {
						for (yt && (yt += Qt); Ct < g;) l[Ct].animatorJustifyOffset = yt, Ct += 1;
						yt = 0, te = !0;
					} else {
						for (o = 0; o < f; o += 1) m = s[o].a, m.t.propType && (te && t.j === 2 && (Qt += m.t.v * $t), S = s[o].s, A = S.getMult(l[g].anIndexes[o], r.a[o].s.totalChars), A.length ? yt += m.t.v * A[0] * $t : yt += m.t.v * A * $t);
						te = !1;
					}
					for (yt && (yt += Qt); Ct < g;) l[Ct].animatorJustifyOffset = yt, Ct += 1;
				}
				for (g = 0; g < E; g += 1) {
					if (n.reset(), gt = 1, l[g].n) h = 0, d += t.yOffset, d += F ? 1 : 0, k = Y, F = !1, this._hasMaskedPath && (p = it, v = mt, b = P[p].points, c = b[v - 1], w = b[v], x = w.partialLength, C = 0), Rt = "", Nt = "", Dt = "", jt = "", qt = this.defaultPropsArray;
					else {
						if (this._hasMaskedPath) {
							if (Bt !== l[g].line) {
								switch (t.j) {
							...
							B !== l[g].ind && (l[B] && (k += l[B].extra), k += l[g].an / 2, B = l[g].ind), k += i[0] * l[g].an * .005;
							var xt = 0;
							for (o = 0; o < f; o += 1) m = s[o].a, m.p.propType && (S = s[o].s, A = S.getMult(l[g].anIndexes[o], r.a[o].s.totalChars), A.length ? xt += m.p.v[0] * A[0] : xt += m.p.v[0] * A), m.a.propType && (S = s[o].s, A = S.getMult(l[g].anIndexes[o], r.a[o].s.totalChars), A.length ? xt += m.a.v[0] * A[0] : xt += m.a.v[0] * A);
							for (y = !0, this._pathData.a.v && (k = l[0].an * .5 + (T - this._pathData.f.v - l[0].an * .5 - l[l.length - 1].an * .5) * B / (E - 1), k += this._pathData.f.v); y;) C + x >= k + xt || !b ? (I = (k + xt - C) / w.partialLength, W = c.point[0] + (w.point[0] - c.point[0]) * I, X = c.point[1] + (w.point[1] - c.point[1]) * I, n.translate(-i[0] * l[g].an * .005, -(i[1] * R) * .01), y = !1) : b && (C += w.partialLength, v += 1, v >= b.length && (v = 0, p += 1, P[p] ? b = P[p].points : D.v.c ? (v = 0, p = 0, b = P[p].points) : (C -= w.partialLength, b = null)), b && (c = w, w = b[v], x = w.partialLength));
							q = l[g].an / 2 - l[g].add, n.translate(-q, 0, 0);
						} else q = l[g].an / 2 - l[g].add, n.translate(-q, 0, 0), n.translate(-i[0] * l[g].an * .005, -i[1] * R * .01, 0);
						for (o = 0; o < f; o += 1) m = s[o].a, m.t.propType && (S = s[o].s, A = S.getMult(l[g].anIndexes[o], r.a[o].s.totalChars), (h !== 0 || t.j !== 0) && (this._hasMaskedPath ? A.length ? k += m.t.v * A[0] : k += m.t.v * A : A.length ? h += m.t.v * A[0] : h += m.t.v * A));
						for (t.strokeWidthAnim && (kt = t.sw || 0), t.strokeColorAnim && (t.sc ? lt = [
							t.sc[0],
							t.sc[1],
							t.sc[2]
						] : lt = [
							...
							t.fc[1],
							t.fc[2]
						]), o = 0; o < f; o += 1) m = s[o].a, m.a.propType && (S = s[o].s, A = S.getMult(l[g].anIndexes[o], r.a[o].s.totalChars), A.length ? n.translate(-m.a.v[0] * A[0], -m.a.v[1] * A[1], m.a.v[2] * A[2]) : n.translate(-m.a.v[0] * A, -m.a.v[1] * A, m.a.v[2] * A));
						for (o = 0; o < f; o += 1) m = s[o].a, m.s.propType && (S = s[o].s, A = S.getMult(l[g].anIndexes[o], r.a[o].s.totalChars), A.length ? n.scale(1 + (m.s.v[0] - 1) * A[0], 1 + (m.s.v[1] - 1) * A[1], 1) : n.scale(1 + (m.s.v[0] - 1) * A, 1 + (m.s.v[1] - 1) * A, 1));
						for (o = 0; o < f; o += 1) {
							if (m = s[o].a, S = s[o].s, A = S.getMult(l[g].anIndexes[o], r.a[o].s.totalChars), m.sk.propType && (A.length ? n.skewFromAxis(-m.sk.v * A[0], m.sa.v * A[1]) : n.skewFromAxis(-m.sk.v * A, m.sa.v * A)), m.r.propType && (A.length ? n.rotateZ(-m.r.v * A[2]) : n.rotateZ(-m.r.v * A)), m.ry.propType && (A.length ? n.rotateY(m.ry.v * A[1]) : n.rotateY(m.ry.v * A)), m.rx.propType && (A.length ? n.rotateX(m.rx.v * A[0]) : n.rotateX(m.rx.v * A)), m.o.propType && (A.length ? gt += (m.o.v * A[0] - gt) * A[0] : gt += (m.o.v * A - gt) * A), t.strokeWidthAnim && m.sw.propType && (A.length ? kt += m.sw.v * A[0] : kt += m.sw.v * A), t.strokeColorAnim && m.sc.propType) for (z = 0; z < 3; z += 1) A.length ? lt[z] += (m.sc.v[z] - lt[z]) * A[0] : lt[z] += (m.sc.v[z] - lt[z]) * A;
							if (t.fillColorAnim && t.fc) {
								if (m.fc.propType) for (z = 0; z < 3; z += 1) A.length ? K[z] += (m.fc.v[z] - K[z]) * A[0] : K[z] += (m.fc.v[z] - K[z]) * A;
								m.fh.propType && (A.length ? K = Ni(K, m.fh.v * A[0]) : K = Ni(K, m.fh.v * A)), m.fs.propType && (A.length ? K = Oi(K, m.fs.v * A[0]) : K = Oi(K, m.fs.v * A)), m.fb.propType && (A.length ? K = Di(K, m.fb.v * A[0]) : K = Di(K, m.fb.v * A));
							}
						}
						for (o = 0; o < f; o += 1) m = s[o].a, m.p.propType && (S = s[o].s, A = S.getMult(l[g].anIndexes[o], r.a[o].s.totalChars), this._hasMaskedPath ? A.length ? n.translate(0, m.p.v[1] * A[0], -m.p.v[2] * A[1]) : n.translate(0, m.p.v[1] * A, -m.p.v[2] * A) : A.length ? n.translate(m.p.v[0] * A[0], m.p.v[1] * A[1], -m.p.v[2] * A[2]) : n.translate(m.p.v[0] * A, m.p.v[1] * A, -m.p.v[2] * A));
						if (t.strokeWidthAnim && (Dt = kt < 0 ? 0 : kt), t.strokeColorAnim && (Jt = "rgb(" + Math.round(lt[0] * 255) + "," + Math.round(lt[1] * 255) + "," + Math.round(lt[2] * 255) + ")"), t.fillColorAnim && t.fc && (Nt = "rgb(" + Math.round(K[0] * 255) + "," + Math.round(K[1] * 255) + "," + Math.round(K[2] * 255) + ")"), this._hasMaskedPath) {
							if (n.translate(0, -t.ls), n.translate(0, i[1] * R * .01 + d, 0), this._pathData.p.v) {
							...
							n.translate(W, X, 0), k -= i[0] * l[g].an * .005, l[g + 1] && B !== l[g + 1].ind && (k += l[g].an / 2, k += t.tr * .001 * t.finalSize);
						} else {
							...
							n.translate(0, -t.ls), n.translate(q, 0, 0), n.translate(i[0] * l[g].an * .005, i[1] * R * .01, 0), h += l[g].l + t.tr * .001 * t.finalSize;
						}
						a === "html" ? Rt = n.toCSS() : a === "svg" ? Rt = n.to2dCSS() : qt = [
							n.props[0],
							n.props[1],
							n.props[2],
							n.props[3],
					...
					u <= g ? (M = new Si(jt, Dt, Jt, Nt, Rt, qt), this.renderedLetters.push(M), u += 1, this.lettersChangedFlag = !0) : (M = this.renderedLetters[g], this.lettersChangedFlag = M.update(jt, Dt, Jt, Nt, Rt, qt) || this.lettersChangedFlag);
				}
			}
		...
		St.prototype.initElement = function(t, e, i) {
			this.lettersChangedFlag = !0, this.initFrame(), this.initBaseData(t, e, i), this.textProperty = new ut(this, t.t, this.dynamicProperties), this.textAnimator = new ae(t.t, this.renderType, this), this.initTransform(t, e, i), this.initHierarchy(), this.initRenderable(), this.initRendererElement(), this.createContainerElements(), this.createRenderableComponents(), this.createContent(), this.hide(), this.textAnimator.searchProperties(this.dynamicProperties);
		}, St.prototype.prepareFrame = function(t) {
			this._mdf = !1, this.prepareRenderableFrame(t), this.prepareProperties(t, this.isInRange);
		}, St.prototype.createPathShape = function(t, e) {
			var i, s = e.length, r, n = "";
			for (i = 0; i < s; i += 1) e[i].ty === "sh" && (r = e[i].ks.k, n += Es(r, r.i.length, !0, t));
			return n;
		...
		}, St.prototype.emptyProp = new Si(), St.prototype.destroy = function() {}, St.prototype.validateText = function() {
		...
		H([
			...
			ne,
			St
		], It), It.prototype.createContent = function() {
			...
			e = a.length;
			var h, d = this.mHelper, g = "", E = this.data.singleShape, l = 0, _ = 0, k = !0, w = i.tr * .001 * i.finalSize;
			if (E && !u && !i.sz) {
				...
				for (e = v.length, _ = i.ps ? i.ps[1] + i.ascent : 0, t = 0; t < e; t += 1) h = this.textSpans[t].span || O("tspan"), h.textContent = v[t], h.setAttribute("x", 0), h.setAttribute("y", _), h.style.display = "inherit", C.appendChild(h), this.textSpans[t] || (this.textSpans[t] = {
					span: null,
					glyph: null
				}), this.textSpans[t].span = h, _ += i.finalLineHeight;
				...
				for (t = 0; t < e; t += 1) {
					...
					if (d.reset(), E && (a[t].n && (l = -w, _ += i.yOffset, _ += k ? 1 : 0, k = !1), this.applyTextPropertiesToMatrix(i, d, a[t].line, l, _), l += a[t].l || 0, l += w), u) {
						...
						this.textSpans[t].glyph = P, P._debug = !0, P.prepareFrame(0), P.renderFrame(), this.textSpans[t].childSpan.appendChild(P.layerElement), c.t === 1 && this.textSpans[t].childSpan.setAttribute("transform", "scale(" + i.finalSize / 100 + "," + i.finalSize / 100 + ")");
		...
		}, Kt.prototype.renderFrame = function() {}, Kt.prototype.getBaseElement = function() {
			return null;
		}, Kt.prototype.destroy = function() {}, Kt.prototype.sourceRectAtTime = function() {}, Kt.prototype.hide = function() {}, H([
			_t,
			Ft,
			At,
			wt
		...
		H([rt], nt), nt.prototype.createNull = function(t) {
			...
			for (; this.pendingElements.length;) {
				...
				if (t.checkParenting(), t.data.tt) for (var e = 0, i = this.elements.length; e < i;) {
					if (this.elements[e] === t) {
						var s = "tp" in t.data ? this.findIndexByInd(t.data.tp) : e - 1, n = this.elements[s].getMatte(this.layers[e].tt);
						t.setMatte(n);
						break;
					}
					e += 1;
			...
			if (i) {
				for (var s = 0, r; s < e;) this.elements[s] && this.elements[s] !== !0 && this.elements[s].getBaseElement() && (r = this.elements[s].getBaseElement()), s += 1;
		...
		H([
			...
			wt,
			ne
		], Lt), Lt.prototype.initElement = function(t, e, i) {
		...
		function he(t, e, i) {
			this.layers = t.layers, this.supports3d = !0, this.completeLayers = !1, this.pendingElements = [], this.elements = this.layers ? $(this.layers.length) : [], this.initElement(t, e, i), this.tm = t.tm ? V.getProp(this, t.tm, 0, e.frameRate, this) : { _placeholder: !0 };
		}
		H([
			nt,
			Lt,
		...
		H([
			...
			wt,
			ne
		], Ve), Ve.prototype.createContent = function() {
			var t;
		...
		function pt(t, e, i) {
			this.shapes = [], this.shapesData = t.shapes, this.stylesList = [], this.shapeModifiers = [], this.itemsData = [], this.processedElements = [], this.animatedContents = [], this.shapesContainer = O("g"), this.initElement(t, e, i), this.prevViewData = [], this.currentBBox = {
				x: 999999,
				y: -999999,
				h: 0,
				w: 0
		...
		H([
			...
			wt,
			de
		], pt), pt.prototype._renderShapeFrame = pt.prototype.renderInnerContent, pt.prototype.createContent = function() {
			var t;
		...
		}, pt.prototype.shapeBoundingBox = {
			left: 0,
			right: 0,
			top: 0,
			bottom: 0
		}, pt.prototype.tempBoundingBox = {
			x: 0,
			xMax: 0,
			y: 0,
			yMax: 0,
			width: 0,
			height: 0
		}, pt.prototype.getBoundsOfCurve = function(t, e, i, s) {
		...
		H([
			...
			ne,
			St
		], Be), Be.prototype.createContent = function() {
		...
		function Ot(t, e, i) {
			...
			this.or = s(this, t.ks.or, 1, U, this), this.or.sh = !0, this.rx = s(this, t.ks.rx, 0, U, this), this.ry = s(this, t.ks.ry, 0, U, this), this.rz = s(this, t.ks.rz, 0, U, this), this.mat = new st(), this._prevMat = new st(), this._isFirstFrame = !0, this.finalTransform = { mProp: this };
		}
		H([
			_t,
			wt,
			At
		], Ot), Ot.prototype.setup = function() {
		...
		}, Ot.prototype.createElements = function() {}, Ot.prototype.hide = function() {}, Ot.prototype.renderFrame = function() {
			...
			if (t || this.pe._mdf || this.p && this.p._mdf || this.px && (this.px._mdf || this.py._mdf || this.pz._mdf) || this.rx._mdf || this.ry._mdf || this.rz._mdf || this.or._mdf || this.a && this.a._mdf) {
				...
				if (this.p ? this.mat.translate(-this.p.v[0], -this.p.v[1], this.p.v[2]) : this.mat.translate(-this.px.v, -this.py.v, this.pz.v), this.a) {
					...
					var n = Math.sqrt(Math.pow(r[0], 2) + Math.pow(r[1], 2) + Math.pow(r[2], 2)), a = [
						r[0] / n,
						r[1] / n,
						r[2] / n
					], u = Math.sqrt(a[2] * a[2] + a[0] * a[0]), h = Math.atan2(a[1], u), d = Math.atan2(a[0], -a[2]);
			...
			this.prepareProperties(t, !0);
		}, Ot.prototype.destroy = function() {}, Ot.prototype.getBaseElement = function() {
			return null;
		};
		function Ei(t, e, i) {
		...
		H([
			...
			wt,
			de
		], Ei), Ei.prototype.createContent = function() {
		...
		H([rt], J), J.prototype.buildItem = Le.prototype.buildItem, J.prototype.checkPendingElements = function() {
			...
			if (i) {
				...
				if (!s.ddd || !this.supports3d) if (this.threeDElements) this.addTo3dContainer(i, e);
					...
					for (var r = 0, n, a, u; r < e;) this.elements[r] && this.elements[r] !== !0 && this.elements[r].getBaseElement && (a = this.elements[r], u = this.layers[r].ddd ? this.getThreeDContainerByPos(r) : a.getBaseElement(), n = u || n), r += 1;
		...
		function Ut(t, e, i) {
			this.layers = t.layers, this.supports3d = !t.hasMask, this.completeLayers = !1, this.pendingElements = [], this.elements = this.layers ? $(this.layers.length) : [], this.initElement(t, e, i), this.tm = t.tm ? V.getProp(this, t.tm, 0, e.frameRate, this) : { _placeholder: !0 };
		}
		H([
			J,
			Lt,
			Vt
		], Ut), Ut.prototype._createBaseContainerElements = Ut.prototype.createContainerElements, Ut.prototype.createContainerElements = function() {
...
//#endregion
export { lottie_light_htmlSLCECTRT as default };

//# sourceMappingURL=lottie_light_html-SLCECTRT-60GLrWik.js.map