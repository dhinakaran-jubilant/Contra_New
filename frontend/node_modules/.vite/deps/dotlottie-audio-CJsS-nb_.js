import { n, t as m } from "./chunk-B7OIQIGJ-CnneQvWT.js";
//#region node_modules/@dotlottie/common/dist/dotlottie-audio.js
var F = n(m((S) => {
	(function() {
		var g = function() {
			this.init();
		...
		g.prototype = {
			...
			volume: function(e) {
				...
				if (e = parseFloat(e), t.ctx || A(), typeof e < "u" && e >= 0 && e <= 1) {
					...
					for (var n = 0; n < t._howls.length; n++) if (!t._howls[n]._webAudio) for (var o = t._howls[n]._getSoundIds(), l = 0; l < o.length; l++) {
						var _ = t._howls[n]._soundById(o[l]);
			...
			_setupCodecs: function() {
				...
				var n = t.canPlayType("audio/mpeg;").replace(/^no$/, ""), o = e._navigator ? e._navigator.userAgent : "", l = o.match(/OPR\/([0-6].)/g), _ = l && parseInt(l[0].split("/")[1], 10) < 33, a = o.indexOf("Safari") !== -1 && o.indexOf("Chrome") === -1, f = o.match(/Version\/(.*?) /), m = a && f && parseInt(f[1], 10) < 15;
				return e._codecs = {
					mp3: !!(!_ && (n || t.canPlayType("audio/mp3;").replace(/^no$/, ""))),
					mpeg: !!n,
		...
		u.prototype = {
			...
			load: function() {
				...
				return e._src = t, e._state = "loading", window.location.protocol === "https:" && t.slice(0, 5) === "http:" && (e._html5 = !0, e._webAudio = !1), new i(e), e._webAudio && d(e), e;
			},
			play: function(e, t) {
				var n = this, o = null;
				if (typeof e == "number") o = e, e = null;
					...
					if (typeof e > "u" && (e = "__default", !n._playLock)) {
						for (var l = 0, _ = 0; _ < n._sounds.length; _++) n._sounds[_]._paused && !n._sounds[_]._ended && (l++, o = n._sounds[_]._id);
						l === 1 ? e = null : o = null;
					}
				}
				...
				var m = Math.max(0, a._seek > 0 ? a._seek : n._sprite[e][0] / 1e3), y = Math.max(0, (n._sprite[e][0] + n._sprite[e][1]) / 1e3 - m), w = y * 1e3 / Math.abs(a._rate), b = n._sprite[e][0] / 1e3, x = (n._sprite[e][0] + n._sprite[e][1]) / 1e3;
				a._sprite = e, a._ended = !1;
				var k = function() {
					a._paused = !1, a._seek = m, a._start = b, a._stop = x, a._loop = !!(a._loop || n._sprite[e][2]);
				};
				if (m >= x) {
					n._ended(a);
					return;
				...
				if (n._webAudio) {
					var I = function() {
						...
						v.gain.setValueAtTime(T, r.ctx.currentTime), a._playStart = r.ctx.currentTime, typeof v.bufferSource.start > "u" ? a._loop ? v.bufferSource.noteGrainOn(0, m, 86400) : v.bufferSource.noteGrainOn(0, m, y) : a._loop ? v.bufferSource.start(0, m, 86400) : v.bufferSource.start(0, m, y), w !== Infinity && (n._endTimers[a._id] = setTimeout(n._ended.bind(n, a), w)), t || setTimeout(function() {
							n._emit("play", a._id), n._loadQueue();
						}, 0);
					};
					r.state === "running" && r.ctx.state !== "interrupted" ? I() : (n._playLock = !0, n.once("resume", I), n._clearTimer(a._id));
				} else {
					var H = function() {
						v.currentTime = m, v.muted = a._muted || n._muted || r._muted || v.muted, v.volume = a._volume * r.volume(), v.playbackRate = a._rate;
						try {
							var T = v.play();
							if (T && typeof Promise < "u" && (T instanceof Promise || typeof T.then == "function") ? (n._playLock = !0, k(), T.then(function() {
								n._playLock = !1, v._unlocked = !0, t ? n._loadQueue() : n._emit("play", a._id);
							}).catch(function() {
							...
							})) : t || (n._playLock = !1, k(), n._emit("play", a._id)), v.playbackRate = a._rate, v.paused) {
							...
							e !== "__default" || a._loop ? n._endTimers[a._id] = setTimeout(n._ended.bind(n, a), w) : (n._endTimers[a._id] = function() {
								n._ended(a), v.removeEventListener("ended", n._endTimers[a._id], !1);
							}, v.addEventListener("ended", n._endTimers[a._id], !1));
						} catch (B) {
							n._emit("playerror", a._id, B);
						}
					};
					v.src === "data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA" && (v.src = n._src, v.load());
					var L = window && window.ejecta || !v.readyState && r._navigator.isCocoonJS;
					if (v.readyState >= 3 || L) H();
					else {
						n._playLock = !0, n._state = "loading";
						var O = function() {
							n._state = "loaded", H(), v.removeEventListener(r._canPlayEvent, O, !1);
						};
						v.addEventListener(r._canPlayEvent, O, !1), n._clearTimer(a._id);
					}
				}
				return a._id;
			},
			pause: function(e) {
				...
				for (var n = t._getSoundIds(e), o = 0; o < n.length; o++) {
					...
					if (l && !l._paused && (l._seek = t.seek(n[o]), l._rateSeek = 0, l._paused = !0, t._stopFade(n[o]), l._node)) if (t._webAudio) {
					...
					} else (!isNaN(l._node.duration) || l._node.duration === Infinity) && l._node.pause();
			...
			stop: function(e, t) {
				...
				for (var o = n._getSoundIds(e), l = 0; l < o.length; l++) {
					n._clearTimer(o[l]);
					var _ = n._soundById(o[l]);
					_ && (_._seek = _._start || 0, _._rateSeek = 0, _._paused = !0, _._ended = !0, n._stopFade(o[l]), _._node && (n._webAudio ? _._node.bufferSource && (typeof _._node.bufferSource.stop > "u" ? _._node.bufferSource.noteOff(0) : _._node.bufferSource.stop(0), n._cleanBuffer(_._node)) : (!isNaN(_._node.duration) || _._node.duration === Infinity) && (_._node.currentTime = _._start || 0, _._node.pause(), _._node.duration === Infinity && n._clearSound(_._node))), t || n._emit("stop", _._id));
				}
				return n;
			},
			mute: function(e, t) {
				...
				if (typeof t > "u") if (typeof e == "boolean") n._muted = e;
				else return n._muted;
				for (var o = n._getSoundIds(t), l = 0; l < o.length; l++) {
					var _ = n._soundById(o[l]);
					_ && (_._muted = e, _._interval && n._stopFade(_._id), n._webAudio && _._node ? _._node.gain.setValueAtTime(e ? 0 : _._volume, r.ctx.currentTime) : _._node && (_._node.muted = r._muted ? !0 : e), n._emit("mute", _._id));
				}
				return n;
			},
			volume: function() {
				...
				if (t.length === 1 || t.length === 2 && typeof t[1] > "u") e._getSoundIds().indexOf(t[0]) >= 0 ? o = parseInt(t[0], 10) : n = parseFloat(t[0]);
				...
				if (typeof n < "u" && n >= 0 && n <= 1) {
					...
					for (var f = 0; f < o.length; f++) a = e._soundById(o[f]), a && (a._volume = n, t[2] || e._stopFade(o[f]), e._webAudio && a._node && !a._muted ? a._node.gain.setValueAtTime(n, r.ctx.currentTime) : a._node && !a._muted && (a._node.volume = n * r.volume()), e._emit("volume", a._id));
				...
				for (var _ = l._getSoundIds(o), a = 0; a < _.length; a++) {
					...
					if (f) {
						if (o || l._stopFade(_[a]), l._webAudio && !f._muted) {
							...
							f._volume = e, f._node.gain.setValueAtTime(e, m), f._node.gain.linearRampToValueAtTime(t, y);
						}
						l._startFadeInterval(f, e, t, n, _[a], typeof o > "u");
					}
				}
				return l;
			},
			_startFadeInterval: function(e, t, n, o, l, _) {
				var a = this, f = t, m = n - t, y = Math.abs(m / .01), w = Math.max(4, y > 0 ? o / y : o), b = Date.now();
				e._fadeTo = n, e._interval = setInterval(function() {
					var x = (Date.now() - b) / o;
					b = Date.now(), f += m * x, f = Math.round(f * 100) / 100, m < 0 ? f = Math.max(n, f) : f = Math.min(n, f), a._webAudio ? e._volume = f : a.volume(f, e._id, !0), _ && (a._volume = f), (n < t && f <= n || n > t && f >= n) && (clearInterval(e._interval), e._interval = null, e._fadeTo = null, a.volume(n, e._id), a._emit("fade", e._id));
				}, w);
			},
			...
			loop: function() {
				...
				else return l = e._soundById(parseInt(t[0], 10)), l ? l._loop : !1;
				else t.length === 2 && (n = t[0], o = parseInt(t[1], 10));
				for (var _ = e._getSoundIds(o), a = 0; a < _.length; a++) l = e._soundById(_[a]), l && (l._loop = n, e._webAudio && l._node && l._node.bufferSource && (l._node.bufferSource.loop = n, n && (l._node.bufferSource.loopStart = l._start || 0, l._node.bufferSource.loopEnd = l._stop, e.playing(_[a]) && (e.pause(_[a], !0), e.play(_[a], !0)))));
				return e;
			},
			rate: function() {
				var e = this, t = arguments, n, o;
				if (t.length === 0) o = e._sounds[0]._id;
				else if (t.length === 1) e._getSoundIds().indexOf(t[0]) >= 0 ? o = parseInt(t[0], 10) : n = parseFloat(t[0]);
				else t.length === 2 && (n = parseFloat(t[0]), o = parseInt(t[1], 10));
				var a;
				if (typeof n == "number") {
					if (e._state !== "loaded" || e._playLock) return e._queue.push({
					...
					for (var f = 0; f < o.length; f++) if (a = e._soundById(o[f]), a) {
						...
						var m = e.seek(o[f]), w = ((e._sprite[a._sprite][0] + e._sprite[a._sprite][1]) / 1e3 - m) * 1e3 / Math.abs(a._rate);
			...
			seek: function() {
				...
				else if (t.length === 1) e._getSoundIds().indexOf(t[0]) >= 0 ? o = parseInt(t[0], 10) : e._sounds.length && (o = e._sounds[0]._id, n = parseFloat(t[0]));
				else t.length === 2 && (n = parseFloat(t[0]), o = parseInt(t[1], 10));
			...
			unload: function() {
				...
				var l = !0;
				for (n = 0; n < r._howls.length; n++) if (r._howls[n]._src === e._src || e._src.indexOf(r._howls[n]._src) >= 0) {
					l = !1;
					break;
				}
			...
			on: function(e, t, n, o) {
				...
				return typeof t == "function" && _.push(o ? {
					id: n,
					fn: t,
					once: o
				} : {
			...
			off: function(e, t, n) {
				...
				if (typeof t == "number" && (n = t, t = null), t || n) for (_ = 0; _ < l.length; _++) {
					var a = n === l[_].id;
					if (t === l[_].fn && a || !t && a) {
						l.splice(_, 1);
						break;
		...
		var c = {}, d = function(e) {
			...
			if (/^data:[^;]+;base64,/.test(t)) {
				for (var n = atob(t.split(",")[1]), o = new Uint8Array(n.length), l = 0; l < n.length; ++l) o[l] = n.charCodeAt(l);
				p(o.buffer, e);
			} else {
				var _ = new XMLHttpRequest();
				_.open(e._xhr.method, t, !0), _.withCredentials = e._xhr.withCredentials, _.responseType = "arraybuffer", e._xhr.headers && Object.keys(e._xhr.headers).forEach(function(a) {
			...
			var n = function() {
				...
				l && t._sounds.length > 0 ? (c[t._src] = l, s(t, l)) : n();
			};
	...
	(function() {
		HowlerGlobal.prototype._pos = [
			...
			if (u = typeof u != "number" ? c._pos[1] : u, i = typeof i != "number" ? c._pos[2] : i, typeof r == "number") c._pos = [
				r,
				u,
				i
			], typeof c.ctx.listener.positionX < "u" ? (c.ctx.listener.positionX.setTargetAtTime(c._pos[0], Howler.ctx.currentTime, .1), c.ctx.listener.positionY.setTargetAtTime(c._pos[1], Howler.ctx.currentTime, .1), c.ctx.listener.positionZ.setTargetAtTime(c._pos[2], Howler.ctx.currentTime, .1)) : c.ctx.listener.setPosition(c._pos[0], c._pos[1], c._pos[2]);
			else return c._pos;
			return c;
			...
			if (u = typeof u != "number" ? s[1] : u, i = typeof i != "number" ? s[2] : i, c = typeof c != "number" ? s[3] : c, d = typeof d != "number" ? s[4] : d, h = typeof h != "number" ? s[5] : h, typeof r == "number") p._orientation = [
				r,
				u,
				i,
				c,
			...
			return function(u) {
				...
				}, i._onstereo = u.onstereo ? [{ fn: u.onstereo }] : [], i._onpos = u.onpos ? [{ fn: u.onpos }] : [], i._onorientation = u.onorientation ? [{ fn: u.onorientation }] : [], r.call(this, u);
			};
			...
			if (typeof u > "u") if (typeof r == "number") i._stereo = r, i._pos = [
				r,
				0,
				0
			];
			...
			for (var d = i._getSoundIds(u), h = 0; h < d.length; h++) {
				...
				if (p) if (typeof r == "number") p._stereo = r, p._pos = [
					r,
					0,
					0
				], p._node && (p._pannerAttr.panningModel = "equalpower", (!p._panner || !p._panner.pan) && g(p, c), c === "spatial" ? typeof p._panner.positionX < "u" ? (p._panner.positionX.setValueAtTime(r, Howler.ctx.currentTime), p._panner.positionY.setValueAtTime(0, Howler.ctx.currentTime), p._panner.positionZ.setValueAtTime(0, Howler.ctx.currentTime)) : p._panner.setPosition(r, 0, 0) : p._panner.pan.setValueAtTime(r, Howler.ctx.currentTime)), i._emit("stereo", p._id);
			...
			if (u = typeof u != "number" ? 0 : u, i = typeof i != "number" ? -.5 : i, typeof c > "u") if (typeof r == "number") d._pos = [
				r,
				u,
				i
			];
			...
			for (var h = d._getSoundIds(c), p = 0; p < h.length; p++) {
				...
				if (s) if (typeof r == "number") s._pos = [
					r,
					u,
					i
				], s._node && ((!s._panner || s._panner.pan) && g(s, "spatial"), typeof s._panner.positionX < "u" ? (s._panner.positionX.setValueAtTime(r, Howler.ctx.currentTime), s._panner.positionY.setValueAtTime(u, Howler.ctx.currentTime), s._panner.positionZ.setValueAtTime(i, Howler.ctx.currentTime)) : s._panner.setPosition(r, u, i)), d._emit("pos", s._id);
				else return s._pos;
			}
			return d;
			...
			if (u = typeof u != "number" ? d._orientation[1] : u, i = typeof i != "number" ? d._orientation[2] : i, typeof c > "u") if (typeof r == "number") d._orientation = [
				r,
				u,
				i
			];
			...
			for (var h = d._getSoundIds(c), p = 0; p < h.length; p++) {
				var s = d._soundById(h[p]);
				if (s) if (typeof r == "number") s._orientation = [
					r,
					u,
					i
				], s._node && (s._panner || (s._pos || (s._pos = d._pos || [
					0,
					0,
					-.5
				]), g(s, "spatial")), typeof s._panner.orientationX < "u" ? (s._panner.orientationX.setValueAtTime(r, Howler.ctx.currentTime), s._panner.orientationY.setValueAtTime(u, Howler.ctx.currentTime), s._panner.orientationZ.setValueAtTime(i, Howler.ctx.currentTime)) : s._panner.setOrientation(r, u, i)), d._emit("orientation", s._id);
			...
			if (u.length === 1) if (typeof u[0] == "object") i = u[0], typeof c > "u" && (i.pannerAttr || (i.pannerAttr = {
			...
			for (var h = r._getSoundIds(c), p = 0; p < h.length; p++) if (d = r._soundById(h[p]), d) {
				var s = d._pannerAttr;
				s = {
					coneInnerAngle: typeof i.coneInnerAngle < "u" ? i.coneInnerAngle : s.coneInnerAngle,
					coneOuterAngle: typeof i.coneOuterAngle < "u" ? i.coneOuterAngle : s.coneOuterAngle,
					coneOuterGain: typeof i.coneOuterGain < "u" ? i.coneOuterGain : s.coneOuterGain,
					distanceModel: typeof i.distanceModel < "u" ? i.distanceModel : s.distanceModel,
					maxDistance: typeof i.maxDistance < "u" ? i.maxDistance : s.maxDistance,
					refDistance: typeof i.refDistance < "u" ? i.refDistance : s.refDistance,
					rolloffFactor: typeof i.rolloffFactor < "u" ? i.rolloffFactor : s.rolloffFactor,
					panningModel: typeof i.panningModel < "u" ? i.panningModel : s.panningModel
				};
				var A = d._panner;
				A ? (A.coneInnerAngle = s.coneInnerAngle, A.coneOuterAngle = s.coneOuterAngle, A.coneOuterGain = s.coneOuterGain, A.distanceModel = s.distanceModel, A.maxDistance = s.maxDistance, A.refDistance = s.refDistance, A.rolloffFactor = s.rolloffFactor, A.panningModel = s.panningModel) : (d._pos || (d._pos = r._pos || [
					0,
					0,
					-.5
				]), g(d, "spatial"));
...
//#endregion
export { M as DotLottieAudio };

//# sourceMappingURL=dotlottie-audio-CJsS-nb_.js.map