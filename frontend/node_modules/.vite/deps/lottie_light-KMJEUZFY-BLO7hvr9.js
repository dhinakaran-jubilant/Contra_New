...
//#region node_modules/@dotlottie/common/dist/lottie_light-KMJEUZFY.js
var lottie_lightKMJEUZFY = m((we, Ye) => {
	typeof navigator < "u" && function(oe, $t) {
		...
		var oe = "http://www.w3.org/2000/svg", $t = "", fi = !1, He = -999999, us = function(e) {
			fi = !!e;
		}, cs = function() {
			return fi;
		}, vs = function(e) {
		...
		var pi = !0, ui = null, Ze = "", gs = /^((?!chrome|android).)*safari/i.test(navigator.userAgent), kt = Math.pow, di = Math.sqrt, Yt = Math.floor, ys = Math.min;
		var mi = 150, J = Math.PI / 180, Rt = .5519;
		function Ue(t, e, i, s) {
		...
		function Je(t, e, i) {
			var s, n, r, o, u, h, m, _;
			switch (o = Math.floor(t * 6), u = t * 6 - o, h = i * (1 - e), m = i * (1 - u * e), _ = i * (1 - (1 - u) * e), o % 6) {
				case 0:
					s = i, n = _, r = h;
					break;
				case 1:
		...
		var le = function() {
						...
						var T = function() {
							...
							return function(v) {
								if (v.chars && !A(F, v.v)) {
									...
									for (k = 0; k < a; k += 1) {
										var l = v.chars[k];
										l.data && l.data.shapes && (c(l.data.shapes), l.data.ip = 0, l.data.op = 99999, l.data.st = 0, l.data.sr = 1, l.data.ks = {
											p: {
												k: [0, 0],
												a: 0
											},
										...
										}, v.chars[k].t || (l.data.shapes.push({ ty: "no" }), l.data.shapes[0].it.push({
											p: {
												k: [0, 0],
												a: 0
											},
			...
			function n(y) {
				var d = 0, f = setInterval(function() {
					(y.getBBox().width || d > 500) && (this._imageLoaded(), clearInterval(f)), d += 1;
				}.bind(this), 50);
			}
			function r(y) {
				var d = s(y, this.assetsPath, this.path), f = W("image");
				gs ? this.testImageLoaded(f) : f.addEventListener("load", this._imageLoaded, !1), f.addEventListener("error", function() {
...
`), s = {}, n, r = 0, o = 0; o < i.length; o += 1) n = i[o].split(":"), n.length === 2 && (s[n[0]] = n[1].trim(), r += 1);
		...
		X([Ci], z), z.prototype.setParams = function(t) {
			...
			this.renderer = new (Es(e))(this, t.rendererSettings), this.imagePreloader.setCacheType(e, this.renderer.globalData.defs), this.renderer.setProjectInterface(this.projectInterface), this.animType = e, t.loop === "" || t.loop === null || t.loop === void 0 || t.loop === !0 ? this.loop = !0 : t.loop === !1 ? this.loop = !1 : this.loop = parseInt(t.loop, 10), this.autoplay = "autoplay" in t ? t.autoplay : !0, this.name = t.name ? t.name : "", this.autoloadSegments = Object.prototype.hasOwnProperty.call(t, "autoloadSegments") ? t.autoloadSegments : !0, this.assetsPath = t.assetsPath, this.initialSegment = t.initialSegment, t.audioFactory && this.audioController.setAudioFactory(t.audioFactory), t.animationData ? this.setupAnimation(t.animationData) : t.path && (t.path.lastIndexOf("\\") !== -1 ? this.path = t.path.substr(0, t.path.lastIndexOf("\\") + 1) : this.path = t.path.substr(0, t.path.lastIndexOf("/") + 1), this.fileName = t.path.substr(t.path.lastIndexOf("/") + 1), this.fileName = this.fileName.substr(0, this.fileName.lastIndexOf(".json")), le.loadAnimation(t.path, this.configAnimation, this.onSetupError));
			...
			this.animationData.__complete = !1, le.completeAnimation(this.animationData, this.onSegmentComplete);
		...
		var tt = function() {
			...
			function p(v, k) {
				v.addEventListener("destroy", u), v.addEventListener("_active", _), v.addEventListener("_idle", M), e.push({
					elem: k,
					animation: v
				}), s += 1;
			}
			...
			return t.registerAnimation = h, t.loadAnimation = b, t.setSpeed = P, t.setDirection = S, t.play = C, t.pause = f, t.stop = g, t.togglePause = A, t.searchAnimations = x, t.resize = I, t.goToAndStop = c, t.destroy = T, t.freeze = N, t.unfreeze = L, t.setVolume = G, t.mute = O, t.unmute = F, t.getRegisteredAnimations = m, t;
		}(), ue = function() {
			var t = {};
			t.getBezierEasing = i;
			var e = {};
			...
			var s = 4, n = .001, r = 1e-7, o = 10, u = 11, h = 1 / (u - 1), m = typeof Float32Array == "function";
			function _(d, f) {
				return 1 - 3 * f + 3 * d;
			}
			function M(d, f) {
			...
			function y(d) {
				this._p = d, this._mSampleValues = m ? new Float32Array(u) : new Array(u), this._precomputed = !1, this.get = this.get.bind(this);
			}
			return y.prototype = {
				get: function(f) {
				...
				_precompute: function() {
					...
					this._precomputed = !0, (f !== c || g !== A) && this._calcSampleValues();
				},
			...
			return function(t, e, i) {
				...
				function h(m) {
					s === n && (r = Ti.double(r), n *= 2), i && i(m), r[s] = m, s += 1;
				}
				return o;
			};
		}(), Mi = function() {
			function t() {
				return {
					addedLength: 0,
					percents: st("float32", he()),
					lengths: st("float32", he())
				};
			}
			return xe(8, t);
		}(), Ei = function() {
		...
		function Fs() {
			...
			function h(p, b) {
				...
				for (var c = S[y] > d ? -1 : 1, g = !0; g;) if (S[y] <= d && S[y + 1] > d ? (f = (d - S[y]) / (S[y + 1] - S[y]), g = !1) : y += c, y < 0 || y >= C - 1) {
					if (y === C - 1) return P[y];
					g = !1;
				}
				return P[y] + (P[y + 1] - P[y]) * f;
			}
			function m(p, b, P, S, C, y) {
				var d = h(C, y), f = 1 - d;
				return [t.round((f * f * f * p[0] + (d * f * f + f * d * f + f * f * d) * P[0] + (d * d * f + f * d * d + d * f * d) * S[0] + d * d * d * b[0]) * 1e3) / 1e3, t.round((f * f * f * p[1] + (d * f * f + f * d * f + f * f * d) * P[1] + (d * d * f + f * d * d + d * f * d) * S[1] + d * d * d * b[1]) * 1e3) / 1e3];
			}
			var _ = st("float32", 8);
		...
		function Fi(t, e) {
			...
			for (var n = e.lastIndex, r = n, o = this.keyframes.length - 1, u = !0, h, m, _; u;) {
			...
			var M, p, b, P, S, C, y = m.t - i, d = h.t - i, f;
			if (h.to) {
				...
				if (t >= y || t < d) {
					...
					for (S = e.lastFrame < t && e._lastKeyframeIndex === r ? e._lastPoint : 0, u = !0, P = c.points.length; u;) {
				...
				var I, j, N, L, G;
				if (o = h.s.length, f = m.s || h.e, this.sh && h.h !== 1) if (t >= y) s[0] = f[0], s[1] = f[1], s[2] = f[2];
		...
		function Is(t, e, i) {
			var s = [], n = t[0], r = t[1], o = t[2], u = t[3], h = e[0], m = e[1], _ = e[2], M = e[3], p, b, P, S, C;
			return b = n * h + r * m + o * _ + u * M, b < 0 && (b = -b, h = -h, m = -m, _ = -_, M = -M), 1 - b > 1e-6 ? (p = Math.acos(b), P = Math.sin(p), S = Math.sin((1 - i) * p) / P, C = Math.sin(i * p) / P) : (S = 1 - i, C = i), s[0] = S * n + C * h, s[1] = S * r + C * m, s[2] = S * o + C * _, s[3] = S * u + C * M, s;
		}
		function Ls(t, e) {
		...
		function Ii(t) {
			var e = t[0] * J, i = t[1] * J, s = t[2] * J, n = Math.cos(e / 2), r = Math.cos(i / 2), o = Math.cos(s / 2), u = Math.sin(e / 2), h = Math.sin(i / 2), m = Math.sin(s / 2), _ = n * r * o - u * h * m;
			return [
				u * h * o + n * r * m,
				u * r * o + n * h * m,
				n * h * o - u * r * m,
		...
		function Os(t, e, i, s) {
			...
			}, this.k = !0, this.kf = !0, this.data = e, this.mult = i || 1, this.elem = t, this.container = s, this.comp = t.comp, this.v = Ht, this.pv = Ht, this._isFirstFrame = !0, this.getValue = Ie, this.setVValue = Fe, this.interpolateValue = Fi, this.effectsSequence = [Li.bind(this)], this.addEffect = Le;
		}
		function Bs(t, e, i, s) {
			this.propType = "multidimensional";
			var n, r = e.k.length, o, u, h, m;
			for (n = 0; n < r - 1; n += 1) e.k[n].to && e.k[n].s && e.k[n + 1] && e.k[n + 1].s && (o = e.k[n].s, u = e.k[n + 1].s, h = e.k[n].to, m = e.k[n].ti, (o.length === 2 && !(o[0] === u[0] && o[1] === u[1]) && Pt.pointOnLine2D(o[0], o[1], u[0], u[1], o[0] + h[0], o[1] + h[1]) && Pt.pointOnLine2D(o[0], o[1], u[0], u[1], u[0] + m[0], u[1] + m[1]) || o.length === 3 && !(o[0] === u[0] && o[1] === u[1] && o[2] === u[2]) && Pt.pointOnLine3D(o[0], o[1], o[2], u[0], u[1], u[2], o[0] + h[0], o[1] + h[1], o[2] + h[2]) && Pt.pointOnLine3D(o[0], o[1], o[2], u[0], u[1], u[2], u[0] + m[0], u[1] + m[1], u[2] + m[2])) && (e.k[n].to = null, e.k[n].ti = null), o[0] === u[0] && o[1] === u[1] && h[0] === 0 && h[1] === 0 && m[0] === 0 && m[1] === 0 && (o.length === 2 || o[2] === u[2] && h[2] === 0 && m[2] === 0) && (e.k[n].to = null, e.k[n].ti = null));
			this.effectsSequence = [Li.bind(this)], this.data = e, this.keyframes = e.k, this.keyframesMetadata = [], this.offsetTime = t.data.st, this.k = !0, this.kf = !0, this._isFirstFrame = !0, this.mult = i || 1, this.elem = t, this.container = s, this.comp = t.comp, this.getValue = Ie, this.setVValue = Fe, this.interpolateValue = Fi, this.frameId = -1;
		...
		Tt.prototype.setPathData = function(t, e) {
			...
			for (u = n; u < o; u += 1) t.setTripleAt(e[r][0], e[r][1], s[r][0], s[r][1], i[r][0], i[r][1], u, !1), r -= 1;
			return t;
		...
		var te = function() {
			...
			function e(y, d, f) {
				...
				if (y < O[0].t - this.offsetTime) g = O[0].s[0], T = !0, c = 0;
				else if (y >= O[O.length - 1].t - this.offsetTime) g = O[O.length - 1].s ? O[O.length - 1].s[0] : O[O.length - 2].e[0], T = !0;
				else {
					for (var F = c, v = O.length - 1, k = !0, a, l, E; k && (a = O[F], l = O[F + 1], !(l.t - this.offsetTime > y));) F < v - 1 ? F += 1 : k = !1;
			...
			function n(y, d) {
				if (y._length !== d._length || y.c !== d.c) return !1;
				var f, c = y._length;
				for (f = 0; f < c; f += 1) if (y.v[f][0] !== d.v[f][0] || y.v[f][1] !== d.v[f][1] || y.o[f][0] !== d.o[f][0] || y.o[f][1] !== d.o[f][1] || y.i[f][0] !== d.i[f][0] || y.i[f][1] !== d.i[f][1]) return !1;
				return !0;
			}
			function r(y) {
				n(this.v, y) || (this.v = at.clone(y), this.localShapeCollection.releaseShapes(), this.localShapeCollection.addShape(this.v), this._mdf = !0, this.paths = this.localShapeCollection);
			}
			function o() {
			...
			function m(y, d, f) {
				...
				this.v = at.newElement(), this.v.setPathData(this.keyframes[0].s[0].c, c), this.pv = at.clone(this.v), this.localShapeCollection = te.newShapeCollection(), this.paths = this.localShapeCollection, this.paths.addShape(this.v), this.lastFrame = t, this.reset = s, this._caching = {
					lastFrame: t,
					lastIndex: 0
			...
			var _ = function() {
				...
				return y.prototype = {
					...
					convertStarToPath: function() {
						var f = Math.floor(this.pt.v) * 2, c = Math.PI * 2 / f, g = !0, A = this.or.v, T = this.ir.v, x = this.os.v, I = this.is.v, j = 2 * Math.PI * A / (f * 2), N = 2 * Math.PI * T / (f * 2), L, G, O, F, v = -Math.PI / 2;
						v += this.r.v;
						...
						for (this.v._length = 0, L = 0; L < f; L += 1) {
							...
							a += +this.p.v[0], l += +this.p.v[1], this.v.setTripleAt(a, l, a - E * F * O * k, l - w * F * O * k, a + E * F * O * k, l + w * F * O * k, L, !0), g = !g, v += c * k;
						}
					},
					convertPolygonToPath: function() {
						var f = Math.floor(this.pt.v), c = Math.PI * 2 / f, g = this.or.v, A = this.os.v, T = 2 * Math.PI * g / (f * 4), x, I = -Math.PI * .5, j = this.data.d === 3 ? -1 : 1;
						for (I += this.r.v, this.v._length = 0, x = 0; x < f; x += 1) {
							...
							N += +this.p.v[0], L += +this.p.v[1], this.v.setTripleAt(N, L, N - G * T * A * j, L - O * T * A * j, N + G * T * A * j, L + O * T * A * j, x, !0), I += c * j;
						}
				...
				function y(d, f) {
					this.v = at.newElement(), this.v.c = !0, this.localShapeCollection = te.newShapeCollection(), this.localShapeCollection.addShape(this.v), this.paths = this.localShapeCollection, this.elem = d, this.comp = d.comp, this.frameId = -1, this.d = f.d, this.initDynamicPropertyContainer(d), this.p = V.getProp(d, f.p, 1, 0, this), this.s = V.getProp(d, f.s, 1, 0, this), this.r = V.getProp(d, f.r, 0, 0, this), this.dynamicProperties.length ? this.k = !0 : (this.k = !1, this.convertRectToPath());
				}
				return y.prototype = {
					convertRectToPath: function() {
						var f = this.p.v[0], c = this.p.v[1], g = this.s.v[0] / 2, A = this.s.v[1] / 2, T = ys(g, A, this.r.v), x = T * (1 - Rt);
						this.v._length = 0, this.d === 2 || this.d === 1 ? (this.v.setTripleAt(f + g, c - A + T, f + g, c - A + T, f + g, c - A + x, 0, !0), this.v.setTripleAt(f + g, c + A - T, f + g, c + A - x, f + g, c + A - T, 1, !0), T !== 0 ? (this.v.setTripleAt(f + g - T, c + A, f + g - T, c + A, f + g - x, c + A, 2, !0), this.v.setTripleAt(f - g + T, c + A, f - g + x, c + A, f - g + T, c + A, 3, !0), this.v.setTripleAt(f - g, c + A - T, f - g, c + A - T, f - g, c + A - x, 4, !0), this.v.setTripleAt(f - g, c - A + T, f - g, c - A + x, f - g, c - A + T, 5, !0), this.v.setTripleAt(f - g + T, c - A, f - g + T, c - A, f - g + x, c - A, 6, !0), this.v.setTripleAt(f + g - T, c - A, f + g - x, c - A, f + g - T, c - A, 7, !0)) : (this.v.setTripleAt(f - g, c + A, f - g + x, c + A, f - g, c + A, 2), this.v.setTripleAt(f - g, c - A, f - g, c - A + x, f - g, c - A, 3))) : (this.v.setTripleAt(f + g, c - A + T, f + g, c - A + x, f + g, c - A + T, 0, !0), T !== 0 ? (this.v.setTripleAt(f + g - T, c - A, f + g - T, c - A, f + g - x, c - A, 1, !0), this.v.setTripleAt(f - g + T, c - A, f - g + x, c - A, f - g + T, c - A, 2, !0), this.v.setTripleAt(f - g, c - A + T, f - g, c - A + T, f - g, c - A + x, 3, !0), this.v.setTripleAt(f - g, c + A - T, f - g, c + A - x, f - g, c + A - T, 4, !0), this.v.setTripleAt(f - g + T, c + A, f - g + T, c + A, f - g + x, c + A, 5, !0), this.v.setTripleAt(f + g - T, c + A, f + g - x, c + A, f + g - T, c + A, 6, !0), this.v.setTripleAt(f + g, c + A - T, f + g, c + A - T, f + g, c + A - x, 7, !0)) : (this.v.setTripleAt(f - g, c - A, f - g + x, c - A, f - g, c - A, 1, !0), this.v.setTripleAt(f - g, c + A, f - g, c + A - x, f - g, c + A, 2, !0), this.v.setTripleAt(f + g, c + A, f + g - x, c + A, f + g, c + A, 3, !0)));
					},
					getValue: function() {
			...
			function b(y, d, f) {
				var c;
				if (f === 3 || f === 4) (f === 3 ? d.pt : d.ks).k.length ? c = new m(y, d, f) : c = new u(y, d, f);
		...
		var ot = function() {
			...
			function S(a, l, E, w, R, q, D, Y, H, et, ut, wt, ct, nt, mt, K) {
				var B = this.props;
				if (a === 1 && l === 0 && E === 0 && w === 0 && R === 0 && q === 1 && D === 0 && Y === 0 && H === 0 && et === 0 && ut === 1 && wt === 0) return B[12] = B[12] * a + B[15] * ct, B[13] = B[13] * q + B[15] * nt, B[14] = B[14] * ut + B[15] * mt, B[15] *= K, this._identityCalculated = !1, this;
				...
				return B[0] = xt * a + Dt * R + Ft * H + Ct * ct, B[1] = xt * l + Dt * q + Ft * et + Ct * nt, B[2] = xt * E + Dt * D + Ft * ut + Ct * mt, B[3] = xt * w + Dt * Y + Ft * wt + Ct * K, B[4] = It * a + Lt * R + vt * H + Wt * ct, B[5] = It * l + Lt * q + vt * et + Wt * nt, B[6] = It * E + Lt * D + vt * ut + Wt * mt, B[7] = It * w + Lt * Y + vt * wt + Wt * K, B[8] = Gt * a + bt * R + Xt * H + St * ct, B[9] = Gt * l + bt * q + Xt * et + St * nt, B[10] = Gt * E + bt * D + Xt * ut + St * mt, B[11] = Gt * w + bt * Y + Xt * wt + St * K, B[12] = Qt * a + We * R + Ge * H + Xe * ct, B[13] = Qt * l + We * q + Ge * et + Xe * nt, B[14] = Qt * E + We * D + Ge * ut + Xe * mt, B[15] = Qt * w + We * Y + Ge * wt + Xe * K, this._identityCalculated = !1, this;
			}
			function C(a) {
				var l = a.props;
			...
			function d(a) {
				for (var l = 0; l < 16;) {
					if (a.props[l] !== this.props[l]) return !1;
					l += 1;
				}
				return !0;
			}
			...
			function G(a, l, E) {
				...
				return this.isIdentity() ? w = [
					...
					a * this.props[0] + l * this.props[4] + E * this.props[8] + this.props[12],
					a * this.props[1] + l * this.props[5] + E * this.props[9] + this.props[13],
					a * this.props[2] + l * this.props[6] + E * this.props[10] + this.props[14]
				], w;
			}
			function O(a, l) {
		...
		function Xs(t) {
			switch (t) {
				...
				case "shapePropertyFactory": return Ve;
				case "matrix": return ot;
				default: return null;
			}
		}
		...
		var Bi = "";
		var Ni = document.getElementsByTagName("script"), zi = Ni[Ni.length - 1] || { src: "" };
		...
		function gt() {}
		gt.prototype.initModifierProperties = function() {}, gt.prototype.addShapeToModifier = function() {}, gt.prototype.addShape = function(t) {
			if (!this.closed) {
		...
		X([gt], _t), _t.prototype.initModifierProperties = function(t, e) {
			...
			var o = [], u, h = r.length, m;
			for (u = 0; u < h; u += 1) if (m = r[u], !(m.e * n < s || m.s * n > s + i)) {
				var _, M;
			...
			var r, o, u = this.shapes.length, h, m, _, M, p, b = 0;
			if (i === e) for (o = 0; o < u; o += 1) this.shapes[o].localShapeCollection.releaseShapes(), this.shapes[o].shape._mdf = !0, this.shapes[o].shape.paths = this.shapes[o].localShapeCollection, this._mdf && (this.shapes[o].pathsData.length = 0);
			else if (i === 1 && e === 0 || i === 0 && e === 1) {
				if (this._mdf) for (o = 0; o < u; o += 1) this.shapes[o].pathsData.length = 0, this.shapes[o].shape._mdf = !0;
			} else {
				var P = [], S, C;
				for (o = 0; o < u; o += 1) if (S = this.shapes[o], !S.shape._mdf && !this._mdf && !t && this.m !== 2) S.shape.paths = S.localShapeCollection;
				else {
					if (r = S.shape.paths, m = r._length, p = 0, !S.shape._mdf && S.pathsData.length) p = S.totalShapeLength;
					else {
						for (_ = this.releasePathsData(S.pathsData), h = 0; h < m; h += 1) M = Pt.getSegmentsLength(r.shapes[h]), _.push(M), p += M.totalLength;
				...
				for (o = u - 1; o >= 0; o -= 1) if (S = this.shapes[o], S.shape._mdf) {
					for (C = S.localShapeCollection, C.releaseShapes(), this.m === 2 && u > 1 ? (c = this.calculateShapeEdges(e, i, S.totalShapeLength, f, b), f += S.totalShapeLength) : c = [[y, d]], m = c.length, h = 0; h < m; h += 1) {
						y = c[h][0], d = c[h][1], P.length = 0, d <= 1 ? P.push({
						...
						if (P[0].s !== P[0].e) {
							if (P.length > 1) if (S.shape.paths.shapes[S.shape.paths._length - 1].c) {
								var T = g.pop();
			...
			var s = t.pathsData, n = t.shape.paths.shapes, r, o = t.shape.paths._length, u, h, m = 0, _, M, p, b, P = [], S, C = !0;
			for (i ? (M = i._length, S = i._length) : (i = at.newElement(), M = 0, S = 0), P.push(i), r = 0; r < o; r += 1) {
				for (p = s[r].lengths, i.c = n[r].c, h = n[r].c ? p.length : p.length + 1, u = 1; u < h; u += 1) if (_ = p[u - 1], m + _.addedLength < e.s) m += _.addedLength, i.c = !1;
				else if (m > e.e) {
					i.c = !1;
					break;
				} else e.s <= m && e.e >= m + _.addedLength ? (this.addSegment(n[r].v[u - 1], n[r].o[u - 1], n[r].i[u], n[r].v[u], i, M, C), C = !1) : (b = Pt.getNewSegment(n[r].v[u - 1], n[r].v[u], n[r].o[u - 1], n[r].i[u], (e.s - m) / _.addedLength, (e.e - m) / _.addedLength, p[u - 1]), this.addSegmentFromArray(b, i, M, C), C = !1, i.c = !1), m += _.addedLength, M += 1;
				if (n[r].c && p.length) {
					if (_ = p[u - 1], m <= e.e) {
						var y = p[u - 1].addedLength;
						e.s <= m && e.e >= m + y ? (this.addSegment(n[r].v[u - 1], n[r].o[u - 1], n[r].i[0], n[r].v[0], i, M, C), C = !1) : (b = Pt.getNewSegment(n[r].v[u - 1], n[r].v[0], n[r].o[u - 1], n[r].i[0], (e.s - m) / y, (e.e - m) / y, p[u - 1]), this.addSegmentFromArray(b, i, M, C), C = !1, i.c = !1);
					} else i.c = !1;
					m += _.addedLength, M += 1;
				}
				if (i._length && (i.setXYAt(i.v[S][0], i.v[S][1], "i", S), i.setXYAt(i.v[i._length - 1][0], i.v[i._length - 1][1], "o", i._length - 1)), m > e.e) break;
				r < o - 1 && (i = at.newElement(), C = !0, P.push(i), M = 0);
			}
			return P;
		};
		function ce() {}
		X([gt], ce), ce.prototype.initModifierProperties = function(t, e) {
			...
			o.c = t.c;
			var u, h, m, _, M, p;
			for (r = 0; r < n; r += 1) u = t.v[r][0] + (s[0] - t.v[r][0]) * i, h = t.v[r][1] + (s[1] - t.v[r][1]) * i, m = t.o[r][0] + (s[0] - t.o[r][0]) * -i, _ = t.o[r][1] + (s[1] - t.o[r][1]) * -i, M = t.i[r][0] + (s[0] - t.i[r][0]) * -i, p = t.i[r][1] + (s[1] - t.i[r][1]) * -i, o.setTripleAt(u, h, m, _, M, p, r);
			return o;
			...
			if (o !== 0) {
				var u, h;
				for (i = 0; i < s; i += 1) {
					if (u = this.shapes[i], h = u.localShapeCollection, !(!u.shape._mdf && !this._mdf && !t)) for (h.releaseShapes(), u.shape._mdf = !0, e = u.shape.paths.shapes, r = u.shape.paths._length, n = 0; n < r; n += 1) h.addShape(this.processPath(e[n], o));
				...
				if (this.elem.globalData.frameId !== this.frameId) {
					if (this._isDirty && (this.precalculateMatrix(), this._isDirty = !1), this.iterateDynamicProperties(), this._mdf || h) {
						...
						if (this.v.cloneFromProps(this.pre.props), this.appliedTransformations < 1 && this.v.translate(-this.a.v[0], -this.a.v[1], this.a.v[2]), this.appliedTransformations < 2 && this.v.scale(this.s.v[0], this.s.v[1], this.s.v[2]), this.sk && this.appliedTransformations < 3 && this.v.skewFromAxis(-this.sk.v, this.sa.v), this.r && this.appliedTransformations < 4 ? this.v.rotate(-this.r.v) : !this.r && this.appliedTransformations < 4 && this.v.rotateZ(-this.rz.v).rotateY(this.ry.v).rotateX(this.rx.v).rotateZ(-this.or.v[2]).rotateY(this.or.v[1]).rotateX(this.or.v[0]), this.autoOriented) {
							var _, M;
							if (m = this.elem.globalData.frameRate, this.p && this.p.keyframes && this.p.getValueAtTime) this.p._caching.lastFrame + this.p.offsetTime <= this.p.keyframes[0].t ? (_ = this.p.getValueAtTime((this.p.keyframes[0].t + .01) / m, 0), M = this.p.getValueAtTime(this.p.keyframes[0].t / m, 0)) : this.p._caching.lastFrame + this.p.offsetTime >= this.p.keyframes[this.p.keyframes.length - 1].t ? (_ = this.p.getValueAtTime(this.p.keyframes[this.p.keyframes.length - 1].t / m, 0), M = this.p.getValueAtTime((this.p.keyframes[this.p.keyframes.length - 1].t - .05) / m, 0)) : (_ = this.p.pv, M = this.p.getValueAtTime((this.p._caching.lastFrame + this.p.offsetTime - .01) / m, this.p.offsetTime));
							else if (this.px && this.px.keyframes && this.py.keyframes && this.px.getValueAtTime && this.py.getValueAtTime) {
								_ = [], M = [];
								var p = this.px, b = this.py;
								p._caching.lastFrame + p.offsetTime <= p.keyframes[0].t ? (_[0] = p.getValueAtTime((p.keyframes[0].t + .01) / m, 0), _[1] = b.getValueAtTime((b.keyframes[0].t + .01) / m, 0), M[0] = p.getValueAtTime(p.keyframes[0].t / m, 0), M[1] = b.getValueAtTime(b.keyframes[0].t / m, 0)) : p._caching.lastFrame + p.offsetTime >= p.keyframes[p.keyframes.length - 1].t ? (_[0] = p.getValueAtTime(p.keyframes[p.keyframes.length - 1].t / m, 0), _[1] = b.getValueAtTime(b.keyframes[b.keyframes.length - 1].t / m, 0), M[0] = p.getValueAtTime((p.keyframes[p.keyframes.length - 1].t - .01) / m, 0), M[1] = b.getValueAtTime((b.keyframes[b.keyframes.length - 1].t - .01) / m, 0)) : (_ = [p.pv, b.pv], M[0] = p.getValueAtTime((p._caching.lastFrame + p.offsetTime - .01) / m, p.offsetTime), M[1] = b.getValueAtTime((b._caching.lastFrame + b.offsetTime - .01) / m, b.offsetTime));
							} else M = t, _ = M;
			...
			function o(h, m, _) {
				if (this.elem = h, this.frameId = -1, this.propType = "transform", this.data = m, this.v = new ot(), this.pre = new ot(), this.appliedTransformations = 0, this.initDynamicPropertyContainer(_ || h), m.p && m.p.s ? (this.px = V.getProp(h, m.p.x, 0, 0, this), this.py = V.getProp(h, m.p.y, 0, 0, this), m.p.z && (this.pz = V.getProp(h, m.p.z, 0, 0, this))) : this.p = V.getProp(h, m.p || { k: [
					...
					if (this.rx = V.getProp(h, m.rx, 0, J, this), this.ry = V.getProp(h, m.ry, 0, J, this), this.rz = V.getProp(h, m.rz, 0, J, this), m.or.k[0].ti) {
						...
						for (M = 0; M < p; M += 1) m.or.k[M].to = null, m.or.k[M].ti = null;
					}
					this.or = V.getProp(h, m.or, 1, J, this), this.or.sh = !0;
				} else this.r = V.getProp(h, m.r || { k: 0 }, 0, J, this);
				m.sk && (this.sk = V.getProp(h, m.sk, 0, J, this), this.sa = V.getProp(h, m.sa, 0, J, this)), this.a = V.getProp(h, m.a || { k: [
					0,
					0,
					0
				] }, 1, 0, this), this.s = V.getProp(h, m.s || { k: [
					100,
					100,
					100
				] }, 1, .01, this), m.o ? this.o = V.getProp(h, m.o, 0, .01, h) : this.o = {
					_mdf: !1,
					v: 1
		...
		X([gt], At), At.prototype.initModifierProperties = function(t, e) {
			this.getValue = this.processKeys, this.c = V.getProp(t, e.c, 0, null, this), this.o = V.getProp(t, e.o, 0, null, this), this.tr = ti.getTransformProperty(t, e.tr, this), this.so = V.getProp(t, e.tr.so, 0, .01, this), this.eo = V.getProp(t, e.tr.eo, 0, .01, this), this.data = e, this.dynamicProperties.length || this.getValue(!0), this._isAnimated = !!this.dynamicProperties.length, this.pMatrix = new ot(), this.rMatrix = new ot(), this.sMatrix = new ot(), this.tMatrix = new ot(), this.matrix = new ot();
			...
			if (this._mdf || t) {
				...
				for (s = 0; s <= this._groups.length - 1; s += 1) {
					if (m = r < u, this._groups[s]._render = m, this.changeGroupRender(this._groups[s].it, m), !m) {
				...
				var d = 0;
				if (p > 0) {
					for (; d < P;) this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, 1, !1), d += 1;
					b && (this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, b, !1), d += b);
				} else if (p < 0) {
					for (; d > P;) this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, 1, !0), d -= 1;
				...
				for (var f, c; r;) {
					if (e = this.elemsData[s].it, i = e[e.length - 1].transform.mProps.v.props, c = i.length, e[e.length - 1].transform.mProps._mdf = !0, e[e.length - 1].transform.op._mdf = !0, e[e.length - 1].transform.op.v = this._currentCopies === 1 ? this.so.v : this.so.v + (this.eo.v - this.so.v) * (s / (this._currentCopies - 1)), d !== 0) {
		...
		X([gt], ve), ve.prototype.initModifierProperties = function(t, e) {
			...
			var i = at.newElement();
			i.c = t.c;
			var s, n = t._length, r, o, u, h, m, _, M = 0, p, b, P, S, C, y;
			for (s = 0; s < n; s += 1) r = t.v[s], u = t.o[s], o = t.i[s], r[0] === u[0] && r[1] === u[1] && r[0] === o[0] && r[1] === o[1] ? (s === 0 || s === n - 1) && !t.c ? (i.setTripleAt(r[0], r[1], u[0], u[1], o[0], o[1], M), M += 1) : (s === 0 ? h = t.v[n - 1] : h = t.v[s - 1], m = Math.sqrt(Math.pow(r[0] - h[0], 2) + Math.pow(r[1] - h[1], 2)), _ = m ? Math.min(m / 2, e) / m : 0, C = r[0] + (h[0] - r[0]) * _, p = C, y = r[1] - (r[1] - h[1]) * _, b = y, P = p - (p - r[0]) * Rt, S = b - (b - r[1]) * Rt, i.setTripleAt(p, b, P, S, C, y, M), M += 1, s === n - 1 ? h = t.v[0] : h = t.v[s + 1], m = Math.sqrt(Math.pow(r[0] - h[0], 2) + Math.pow(r[1] - h[1], 2)), _ = m ? Math.min(m / 2, e) / m : 0, P = r[0] + (h[0] - r[0]) * _, p = P, S = r[1] + (h[1] - r[1]) * _, b = S, C = p - (p - r[0]) * Rt, y = b - (b - r[1]) * Rt, i.setTripleAt(p, b, P, S, C, y, M), M += 1) : (i.setTripleAt(t.v[s][0], t.v[s][1], t.o[s][0], t.o[s][1], t.i[s][0], t.i[s][1], M), M += 1);
			return i;
		...
		function U(t, e, i, s, n) {
			...
			this.a = [r[0], o[0]], this.b = [r[1], o[1]], this.c = [r[2], o[2]], this.d = [r[3], o[3]], this.points = [
				t,
				e,
				i,
				s
		...
		function Xi(t, e, i, s, n, r, o) {
			var u = i - Math.PI / 2, h = i + Math.PI / 2, m = e[0] + Math.cos(i) * s * n, _ = e[1] - Math.sin(i) * s * n;
			t.setTripleAt(m, _, m + Math.cos(u) * r, _ - Math.sin(u) * r, m + Math.cos(h) * o, _ - Math.sin(h) * o, t.length());
		}
		function Qs(t, e) {
		...
		function Yi(t, e, i, s, n, r, o) {
			var u = $s(e, i), h = e.v[i % e._length], m = e.v[i === 0 ? e._length - 1 : i - 1], _ = e.v[(i + 1) % e._length], M = r === 2 ? Math.sqrt(Math.pow(h[0] - m[0], 2) + Math.pow(h[1] - m[1], 2)) : 0, p = r === 2 ? Math.sqrt(Math.pow(h[0] - _[0], 2) + Math.pow(h[1] - _[1], 2)) : 0;
			Xi(t, e.v[i % e._length], u, o, s, p / ((n + 1) * 2), M / ((n + 1) * 2));
		}
		function tr(t, e, i, s, n, r) {
			for (var o = 0; o < s; o += 1) {
				var u = (o + 1) / (s + 1), h = n === 2 ? Math.sqrt(Math.pow(e.points[3][0] - e.points[0][0], 2) + Math.pow(e.points[3][1] - e.points[0][1], 2)) : 0, m = e.normalAngle(u);
				Xi(t, e.point(u), m, r, i, h / ((s + 1) * 2), h / ((s + 1) * 2)), r = -r;
			}
			return r;
		}
		me.prototype.processPath = function(t, e, i, s) {
			...
			if (o !== 0) {
				var m, _;
				for (i = 0; i < s; i += 1) {
					if (m = this.shapes[i], _ = m.localShapeCollection, !(!m.shape._mdf && !this._mdf && !t)) for (_.releaseShapes(), m.shape._mdf = !0, e = m.shape.paths.shapes, r = m.shape.paths._length, n = 0; n < r; n += 1) _.addShape(this.processPath(e[n], o, u, h));
		...
		function se(t, e) {
			var i, s, n, r, o, u, h = ri(t.points[0], t.points[1], e);
			i = h[0], s = h[1], h = ri(t.points[1], t.points[2], e), n = h[0], r = h[1], h = ri(t.points[2], t.points[3], e), o = h[0], u = h[1];
			var m = ze(i, s, n, r);
			m === null && (m = s);
			var _ = ze(o, u, n, r);
			return _ === null && (_ = o), new U(i, m, _, u);
		}
		function Hi(t, e, i, s, n) {
			var r = e.points[3], o = i.points[0];
			if (s === 3 || ie(r, o)) return r;
			if (s === 2) {
				var u = -e.tangentAngle(1), h = -i.tangentAngle(0) + Math.PI, m = ze(r, ee(r, u + Math.PI / 2, 100), o, ee(o, u + Math.PI / 2, 100)), _ = m ? si(m, r) : si(r, o) / 2, M = ee(r, u, 2 * _ * Rt);
				return t.setXYAt(M[0], M[1], "o", t.length() - 1), M = ee(o, h, 2 * _ * Rt), t.setTripleAt(o[0], o[1], o[0], o[1], M[0], M[1], t.length()), o;
			}
			var P = ze(ie(r, e.points[2]) ? e.points[0] : e.points[2], r, o, ie(o, i.points[1]) ? i.points[3] : i.points[1]);
		...
		function Ui(t, e) {
			...
			r = t.split(i[0]), s = r[0];
			var u = (i[1] - i[0]) / (1 - i[0]);
			return r = r[1].split(u), o = r[0], n = r[1], [
				se(s, e),
				se(o, e),
				se(n, e)
			];
		...
		X([gt], ge), ge.prototype.initModifierProperties = function(t, e) {
			...
			t.c || (r -= 1);
			var o, u, h, m = [];
			for (o = 0; o < r; o += 1) h = U.shapeSegment(t, o), m.push(Ui(h, e));
			if (!t.c) for (o = r - 1; o >= 0; o -= 1) h = U.shapeSegmentInverted(t, o), m.push(Ui(h, e));
			m = er(m);
			var _ = null, M = null;
			...
			return m.length && Hi(n, M, m[0][0], i, s), n;
			...
			if (o !== 0) {
				var m, _;
				for (i = 0; i < s; i += 1) {
					if (m = this.shapes[i], _ = m.localShapeCollection, !(!m.shape._mdf && !this._mdf && !t)) for (_.releaseShapes(), m.shape._mdf = !0, e = m.shape.paths.shapes, r = m.shape.paths._length, n = 0; n < r; n += 1) _.addShape(this.processPath(e[n], o, h, u));
					m.shape.paths = m.localShapeCollection;
				}
			}
			this.dynamicProperties.length || (this._mdf = !1);
		...
		var Kt = function() {
			...
			var s = 127988, n = 917631, r = 917601, o = 917626, u = 65039, h = 8205, m = 127462, _ = 127487, M = [
				"d83cdffb",
				"d83cdffc",
				"d83cdffd",
				"d83cdffe",
			...
			function b(v, k) {
				var a = Vt("span");
				a.setAttribute("aria-hidden", !0), a.style.fontFamily = k;
				var l = Vt("span");
				...
				var E = l.offsetWidth;
				return l.style.fontFamily = p(v) + ", " + k, {
					node: l,
					w: E,
					parent: a
				};
			...
			function P() {
				...
				for (v = 0; v < k; v += 1) this.fonts[v].loaded ? E -= 1 : this.fonts[v].fOrigin === "n" || this.fonts[v].origin === 0 ? this.fonts[v].loaded = !0 : (a = this.fonts[v].monoCase.node, l = this.fonts[v].monoCase.w, a.offsetWidth !== l ? (E -= 1, this.fonts[v].loaded = !0) : (a = this.fonts[v].sansCase.node, l = this.fonts[v].sansCase.w, a.offsetWidth !== l && (E -= 1, this.fonts[v].loaded = !0)), this.fonts[v].loaded && (this.fonts[v].sansCase.parent.parentNode.removeChild(this.fonts[v].sansCase.parent), this.fonts[v].monoCase.parent.parentNode.removeChild(this.fonts[v].monoCase.parent)));
			...
			function C(v, k) {
				...
				if (!document.body) {
					this.isLoaded = !0, v.list.forEach(function(ut) {
				...
				for (l = 0; l < E; l += 1) {
					var R = !0, q, D;
					if (a[l].loaded = !1, a[l].monoCase = b(a[l].fFamily, "monospace"), a[l].sansCase = b(a[l].fFamily, "sans-serif"), !a[l].fPath) a[l].loaded = !0, w -= 1;
						...
						for (q = document.querySelectorAll("link[f-forigin=\"g\"], link[f-origin=\"1\"]"), D = 0; D < q.length; D += 1) q[D].href.indexOf(a[l].fPath) !== -1 && (R = !1);
						if (R) {
							var H = Vt("link");
						...
						for (q = document.querySelectorAll("script[f-forigin=\"t\"], script[f-origin=\"2\"]"), D = 0; D < q.length; D += 1) a[l].fPath === q[D].src && (R = !1);
						if (R) {
							var et = Vt("link");
			...
			function y(v) {
				if (v) {
					...
					for (k = 0; k < a; k += 1) {
						for (l = 0, w = !1; l < E;) this.chars[l].style === v[k].style && this.chars[l].fFamily === v[k].fFamily && this.chars[l].ch === v[k].ch && (w = !0), l += 1;
			...
			function d(v, k, a) {
				...
				return (typeof v == "string" && v.charCodeAt(0) !== 13 || !v) && console && console.warn && !this._warned && (this._warned = !0, console.warn("Missing character from exported characters list: ", v, k, a)), e;
			}
			function f(v, k, a) {
			...
			function L(v, k) {
				...
				var l = 0;
				for (k += 2; l < 5;) {
					if (a = g(v.substr(k, 2)), a < r || a > o) return !1;
					l += 1, k += 2;
				}
		...
		qt.prototype.prepareFrame = function() {}, X([
			qe,
			Nt,
			zt
		], qt), qt.prototype.getBaseElement = function() {
			return null;
		}, qt.prototype.renderFrame = function() {}, qt.prototype.destroy = function() {}, qt.prototype.initExpressions = function() {}, qt.prototype.getFootageData = function() {
		...
		pt.prototype.prepareFrame = function(t) {
			...
			Nt,
			zt
		], pt), pt.prototype.renderFrame = function() {
			this.isInRange && this._canPlay && (this._isPlaying ? (!this.audio.playing() || Math.abs(this._currentTime / this.globalData.frameRate - this.audio.seek()) > .1) && this.audio.seek(this._currentTime / this.globalData.frameRate) : (this.audio.play(), this.audio.seek(this._currentTime / this.globalData.frameRate), this._isPlaying = !0));
		}, pt.prototype.show = function() {}, pt.prototype.hide = function() {
			...
			return null;
		}, pt.prototype.destroy = function() {}, pt.prototype.sourceRectAtTime = function() {}, pt.prototype.initExpressions = function() {};
		function ht() {}
		ht.prototype.checkLayers = function(t) {
			...
			for (var s = this.elements, n = this.layers, r = 0, o = n.length; r < o;) n[r].ind == e && (!s[r] || s[r] === !0 ? (this.buildItem(r), this.addPendingElement(t)) : (i.push(s[r]), s[r].setAsParent(), n[r].parent !== void 0 ? this.buildElementParenting(t, n[r].parent, i) : t.setHierarchy(i))), r += 1;
		...
		re.prototype = {
			initTransform: function() {
				var e = new ot();
				this.finalTransform = {
					mProp: this.data.ks ? ti.getTransformProperty(this, this.data.ks, this) : { o: 0 },
					_matMdf: !1,
					_localMatMdf: !1,
					_opMdf: !1,
					mat: e,
			...
			globalToLocal: function(e) {
				...
				var r, o = i.length, u;
				for (r = 0; r < o; r += 1) u = i[r].mat.applyToPointArray(0, 0, 0), e = [
					e[0] - u[0],
					e[1] - u[1],
					0
				];
		...
		function Ut(t, e, i) {
			...
			var o, u = this.masksProperties, h = 0, m = [], _, M, p = ft(), b, P, S, C, y = "clipPath", d = "clip-path";
			for (n = 0; n < r; n += 1) if ((u[n].mode !== "a" && u[n].mode !== "n" || u[n].inv || u[n].o.k !== 100 || u[n].o.x) && (y = "mask", d = "mask"), (u[n].mode === "s" || u[n].mode === "i") && h === 0 ? (b = W("rect"), b.setAttribute("fill", "#ffffff"), b.setAttribute("width", this.element.comp.data.w || 0), b.setAttribute("height", this.element.comp.data.h || 0), m.push(b)) : b = null, o = W("path"), u[n].mode === "n") this.viewData[n] = {
				op: V.getProp(this.element, u[n].o, 0, .01, this.element),
				prop: Ve.getShapeProp(this.element, u[n], 3),
				elem: o,
				lastPath: ""
			}, s.appendChild(o);
			else {
				...
				if (u[n].x.k !== 0 ? (y = "mask", d = "mask", C = V.getProp(this.element, u[n].x, 0, null, this.element), f = ft(), P = W("filter"), P.setAttribute("id", f), S = W("feMorphology"), S.setAttribute("operator", "erode"), S.setAttribute("in", "SourceGraphic"), S.setAttribute("radius", "0"), P.appendChild(S), s.appendChild(P), o.setAttribute("stroke", u[n].mode === "s" ? "#000000" : "#ffffff")) : (S = null, C = null), this.storedData[n] = {
					...
					M = m.length;
					var c = W("g");
					for (_ = 0; _ < M; _ += 1) c.appendChild(m[_]);
					var g = W("mask");
					g.setAttribute("mask-type", "alpha"), g.setAttribute("id", p + "_" + h), g.appendChild(o), s.appendChild(g), c.setAttribute("mask", "url(" + dt() + "#" + p + "_" + h + ")"), m.length = 0, m.push(c);
				} else m.push(o);
			...
			for (this.maskElement = W(y), r = m.length, n = 0; n < r; n += 1) this.maskElement.appendChild(m[n]);
		...
		function ai(t) {
			var e, i = "SourceGraphic", s = t.data.ef ? t.data.ef.length : 0, n = ft(), r = _e.createFilter(n, !0), o = 0;
			this.filters = [];
			var u;
			for (e = 0; e < s; e += 1) {
				u = null;
				...
				if (je[h]) {
					var m = je[h].effect;
					u = new m(r, t.effectsManager.effectElements[e], t, es + o, i), i = es + o, je[h].countsAsEffect && (o += 1);
				}
			...
			getMatte: function(e) {
				if (this.matteMasks || (this.matteMasks = {}), !this.matteMasks[e]) {
					...
					if (e === 1 || e === 3) {
						...
						var m = W("g");
						h.appendChild(m), s = ft(), n = _e.createFilter(s);
		...
		function De(t, e, i, s) {
			this.elem = t, this.frameId = -1, this.dataProps = $(e.length), this.renderer = i, this.k = !1, this.dashStr = "", this.dashArray = st("float32", e.length ? e.length - 1 : 0), this.dashoffset = st("float32", 1), this.initDynamicPropertyContainer(s);
			var n, r = e.length || 0, o;
			for (n = 0; n < r; n += 1) o = V.getProp(t, e[n].v, 0, 0, this), this.k = o.k || this.k, this.dataProps[n] = {
				n: e[n].n,
				p: o
			};
		...
		function os(t, e, i) {
			this.initDynamicPropertyContainer(t), this.getValue = this.iterateDynamicProperties, this.o = V.getProp(t, e.o, 0, .01, this), this.w = V.getProp(t, e.w, 0, null, this), this.d = new De(t, e.d || {}, "svg", this), this.c = V.getProp(t, e.c, 1, 255, this), this.style = i, this._isAnimated = !!this._isAnimated;
		}
		X([rt], os);
		function hs(t, e, i) {
		...
		ae.prototype.initGradientData = function(t, e, i) {
			this.o = V.getProp(t, e.o, 0, .01, this), this.s = V.getProp(t, e.s, 1, null, this), this.e = V.getProp(t, e.e, 1, null, this), this.h = V.getProp(t, e.h || { k: 0 }, 0, .01, this), this.a = V.getProp(t, e.a || { k: 0 }, 0, J, this), this.g = new Pe(t, e.g, this), this.style = i, this.stops = [], this.setGradientData(i.pElem, e), this.setGradientOpacity(e, i), this._isAnimated = !!this._isAnimated;
			...
			if (this.g._hasOpacity && !this.g._collapsable) {
				...
				m.setAttribute("id", u), m.setAttribute("spreadMethod", "pad"), m.setAttribute("gradientUnits", "userSpaceOnUse"), n = t.g.k.k[0].s ? t.g.k.k[0].s.length : t.g.k.k.length;
				var _ = this.stops;
				for (s = t.g.p * 4; s < n; s += 2) i = W("stop"), i.setAttribute("stop-color", "rgb(255,255,255)"), m.appendChild(i), _.push(i);
				o.setAttribute(t.ty === "gf" ? "fill" : "stroke", "url(" + dt() + "#" + u + ")"), t.ty === "gs" && (o.setAttribute("stroke-linecap", ss[t.lc || 2]), o.setAttribute("stroke-linejoin", rs[t.lj || 2]), t.lj === 1 && o.setAttribute("stroke-miterlimit", t.ml)), this.of = m, this.ms = r, this.ost = _, this.maskId = h, e.msElem = o;
			}
		}, X([rt], ae);
		function fs(t, e, i) {
		...
		var ps = function(e, i, s, n) {
			if (i === 0) return "";
			var r = e.o, o = e.i, u = e.v, h, m = " M" + n.applyToPointStringified(u[0][0], u[0][1]);
			for (h = 1; h < i; h += 1) m += " C" + n.applyToPointStringified(r[h - 1][0], r[h - 1][1]) + " " + n.applyToPointStringified(o[h][0], o[h][1]) + " " + n.applyToPointStringified(u[h][0], u[h][1]);
			return s && i && (m += " C" + n.applyToPointStringified(r[h - 1][0], r[h - 1][1]) + " " + n.applyToPointStringified(o[0][0], o[0][1]) + " " + n.applyToPointStringified(u[0][0], u[0][1]), m += "z"), m;
		}, dr = function() {
		...
		X([
			...
			var t, e = this.shapes.length, i, s, n = this.stylesList.length, r, o = [], u = !1;
			for (s = 0; s < n; s += 1) {
				for (r = this.stylesList[s], u = !1, o.length = 0, t = 0; t < e; t += 1) i = this.shapes[t], i.styles.indexOf(r) !== -1 && (o.push(i), u = i._isAnimated || u);
			...
			else if (t.ty === "gf" || t.ty === "gs") i = new (t.ty === "gf" ? ae : fs)(this, t, s), this.globalData.defs.appendChild(i.gf), i.maskId && (this.globalData.defs.appendChild(i.ms), this.globalData.defs.appendChild(i.of), n.setAttribute("mask", "url(" + dt() + "#" + i.maskId + ")"));
			...
			var r = new ns(e, i, Ve.getShapeProp(this, t, s, this));
			...
			var u = [].concat(r), h, m = t.length - 1, _, M, p = [], b = [], P, S, C;
			for (h = m; h >= 0; h -= 1) {
				if (C = this.searchProcessedElement(t[h]), C ? e[h] = i[C - 1] : t[h]._render = o, t[h].ty === "fl" || t[h].ty === "st" || t[h].ty === "gf" || t[h].ty === "gs" || t[h].ty === "no") C ? e[h].style.closed = !1 : e[h] = this.createStyleElement(t[h], n), t[h]._render && e[h].style.pElem.parentNode !== s && s.appendChild(e[h].style.pElem), p.push(e[h].style);
				else if (t[h].ty === "gr") {
				...
				} else t[h].ty === "tr" ? (C || (e[h] = this.createTransformElement(t[h], s)), P = e[h].transform, u.push(P)) : t[h].ty === "sh" || t[h].ty === "rc" || t[h].ty === "el" || t[h].ty === "sr" ? (C || (e[h] = this.createShapeElement(t[h], u, n)), this.setElementStyles(e[h])) : t[h].ty === "tm" || t[h].ty === "rd" || t[h].ty === "ms" || t[h].ty === "pb" || t[h].ty === "zz" || t[h].ty === "op" ? (C ? (S = e[h], S.closed = !1) : (S = Ot.getModifier(t[h].ty), S.init(this, t[h]), e[h] = S, this.shapeModifiers.push(S)), b.push(S)) : t[h].ty === "rp" && (C ? (S = e[h], S.closed = !0) : (S = Ot.getModifier(t[h].ty), e[h] = S, S.init(this, t, h, e), this.shapeModifiers.push(S), o = !1), b.push(S));
				this.addProcessedElement(t[h], h + 1);
			}
			for (m = p.length, h = 0; h < m; h += 1) p[h].closed = !0;
			for (m = b.length, h = 0; h < m; h += 1) b[h].closed = !0;
		...
		function lt(t, e) {
			this._frameId = He, this.pv = "", this.v = "", this.kf = !1, this._isFirstFrame = !0, this._mdf = !1, e.d && e.d.sid && (e.d = t.globalData.slotManager.getProp(e.d)), this.data = e, this.elem = t, this.comp = this.elem.comp, this.keysIndex = 0, this.canResize = !1, this.minimumFontSize = 1, this.effectsSequence = [], this.currentData = {
				ascent: 0,
		...
		lt.prototype.defaultBoxWidth = [0, 0], lt.prototype.copyData = function(t, e) {
			...
			for (var e = [], i = 0, s = t.length, n, r, o = !1, u = !1, h = ""; i < s;) o = u, u = !1, n = t.charCodeAt(i), h = t.charAt(i), Kt.isCombinedCharacter(n) ? o = !0 : n >= 55296 && n <= 56319 ? Kt.isRegionalFlag(t, i) ? h = t.substr(i, 14) : (r = t.charCodeAt(i + 1), r >= 56320 && r <= 57343 && (Kt.isModifier(n, r) ? (h = t.substr(i, 2), o = !0) : Kt.isFlagEmoji(t.substr(i, 4)) ? h = t.substr(i, 4) : h = t.substr(i, 2))) : n > 56319 ? (r = t.charCodeAt(i + 1), Kt.isVariationSelector(n) && (o = !0)) : Kt.isZeroWidthJoiner(n) && (o = !0, u = !0), o ? (e[e.length - 1] += h, o = !1) : e.push(h), i += h.length;
			return e;
		}, lt.prototype.completeTextData = function(t) {
			t.__complete = !0;
			var e = this.elem.globalData.fontManager, i = this.data, s = [], n, r, o, u = 0, h, m = i.m.g, _ = 0, M = 0, p = 0, b = [], P = 0, S = 0, C, y, d = e.getFontByName(t.f), f, c = 0, g = Ji(d);
			...
			P = -A, c = 0;
			var O = 0, F;
			for (n = 0; n < r; n += 1) if (o = !1, F = t.finalText[n], T = F.charCodeAt(0), T === 13 || T === 3 ? (O = 0, b.push(P), S = P > S ? P : S, P = -2 * A, h = "", o = !0, p += 1) : h = F, e.chars ? (f = e.getCharData(F, d.fStyle, e.getFontByName(t.f).fFamily), c = o ? 0 : f.w * t.finalSize / 100) : c = e.measureText(h, t.f, t.finalSize), F === " " ? O += c + A : (P += c + A + O, O = 0), s.push({
				l: c,
				an: c,
				add: _,
				n: o,
			...
			var l, E, w = [];
			for (C = 0; C < y; C += 1) {
				for (k = v[C], k.a.sc && (t.strokeColorAnim = !0), k.a.sw && (t.strokeWidthAnim = !0), (k.a.fc || k.a.fh || k.a.fs || k.a.fb) && (t.fillColorAnim = !0), E = 0, l = k.s.b, n = 0; n < r; n += 1) a = s[n], a.anIndexes[C] = E, (l == 1 && a.val !== "" || l == 2 && a.val !== "" && a.val !== " " || l == 3 && (a.n || a.val == " " || n == r - 1) || l == 4 && (a.n || n == r - 1)) && (k.s.rn === 1 && w.push(E), E += 1);
		...
		var mr = function() {
			...
			function s(r, o) {
				this._currentTextLength = -1, this.k = !1, this.data = o, this.elem = r, this.comp = r.comp, this.finalS = 0, this.finalE = 0, this.initDynamicPropertyContainer(r), this.s = V.getProp(r, o.s || { k: 0 }, 0, 0, this), "e" in o ? this.e = V.getProp(r, o.e, 0, 0, this) : this.e = { v: 100 }, this.o = V.getProp(r, o.o || { k: 0 }, 0, 0, this), this.xe = V.getProp(r, o.xe || { k: 0 }, 0, 0, this), this.ne = V.getProp(r, o.ne || { k: 0 }, 0, 0, this), this.sm = V.getProp(r, o.sm || { k: 100 }, 0, 0, this), this.a = V.getProp(r, o.a, 0, .01, this), this.dynamicProperties.length || this.getValue();
			}
			s.prototype = {
				getMult: function(o) {
					this._currentTextLength !== this.elem.textProperty.currentData.l.length && this.getValue();
					var u = 0, h = 0, m = 1, _ = 1;
					this.ne.v > 0 ? u = this.ne.v / 100 : h = -this.ne.v / 100, this.xe.v > 0 ? m = 1 - this.xe.v / 100 : _ = 1 + this.xe.v / 100;
					var M = ue.getBezierEasing(u, h, m, _).get, p = 0, b = this.finalS, P = this.finalE, S = this.data.sh;
					if (S === 2) P === b ? p = o >= P ? 1 : 0 : p = t(0, e(.5 / (P - b) + (o - b) / (P - b), 1)), p = M(p);
					else if (S === 3) P === b ? p = o >= P ? 0 : 1 : p = 1 - t(0, e(.5 / (P - b) + (o - b) / (P - b), 1)), p = M(p);
					else if (S === 4) P === b ? p = 0 : (p = t(0, e(.5 / (P - b) + (o - b) / (P - b), 1)), p < .5 ? p *= 2 : p = 1 - 2 * (p - .5)), p = M(p);
					else if (S === 5) {
						if (P === b) p = 0;
						else {
							var C = P - b;
						...
						p = M(p);
					} else S === 6 ? (P === b ? p = 0 : (o = e(t(0, o + .5 - b), P - b), p = (1 + Math.cos(Math.PI + Math.PI * 2 * o / (P - b))) / 2), p = M(p)) : (o >= i(b) && (o - b < 0 ? p = t(0, e(e(P, 1) - (b - o), 1)) : p = t(0, e(P - o, 1))), p = M(p));
					if (this.sm.v !== 100) {
						var f = this.sm.v * .01;
						f === 0 && (f = 1e-8);
						var c = .5 - f * .5;
				...
				getValue: function(o) {
					...
					var u = this.data.r === 2 ? 1 : 100 / this.data.totalChars, h = this.o.v / u, m = this.s.v / u + h, _ = this.e.v / u + h;
					if (m > _) {
						var M = m;
						m = _, _ = M;
					}
		...
		function gr(t, e, i) {
			var s = { propType: !1 }, n = V.getProp, r = e.a;
			this.a = {
		...
		Jt.prototype.searchProperties = function() {
			...
			if (this.lettersChangedFlag = e, !(!this._mdf && !this._isFirstFrame && !e && (!this._hasMaskedPath || !this._pathData.m._mdf))) {
				...
				var i = this._moreOptions.alignment.v, s = this._animatorsData, n = this._textData, r = this.mHelper, o = this._renderType, u = this.renderedLetters.length, h, m, _, M, p = t.l, b, P, S, C, y, d, f, c, g, A, T, x, I, j, N;
				if (this._hasMaskedPath) {
					...
					if (b = this._pathData.pi, P = this._pathData.f.v, f = 0, d = 1, C = 0, y = !0, A = b.segments, P < 0 && N.v.c) for (b.tLength < Math.abs(P) && (P = -Math.abs(P) % b.tLength), f = A.length - 1, g = A[f].points, d = g.length - 1; P < 0;) P += g[d].partialLength, d -= 1, d < 0 && (f -= 1, g = A[f].points, d = g.length - 1);
					g = A[f].points, c = g[d - 1], S = g[d], T = S.partialLength;
				}
				M = p.length, h = 0, m = 0;
				var O = t.finalSize * 1.2 * .714, F = !0, v, k, a, l = s.length, E;
				var w, R = -1, q, D, Y, H = P, et = f, ut = d, wt = -1, ct, nt, mt, K, B, xt, Dt, Ft, Ct = "", It = this.defaultPropsArray, Lt;
				if (t.j === 2 || t.j === 1) {
					var vt = 0, Wt = 0, Gt = t.j === 2 ? -.5 : -1, bt = 0, Xt = !0;
				...
				for (_ = 0; _ < M; _ += 1) {
					if (r.reset(), ct = 1, p[_].n) h = 0, m += t.yOffset, m += F ? 1 : 0, P = H, F = !1, this._hasMaskedPath && (f = et, d = ut, g = A[f].points, c = g[d - 1], S = g[d], T = S.partialLength, C = 0), Ct = "", Ft = "", xt = "", Lt = "", It = this.defaultPropsArray;
					else {
						if (this._hasMaskedPath) {
							if (wt !== p[_].line) {
								switch (t.j) {
							...
							R !== p[_].ind && (p[R] && (P += p[R].extra), P += p[_].an / 2, R = p[_].ind), P += i[0] * p[_].an * .005;
							var St = 0;
							...
							for (y = !0, this._pathData.a.v && (P = p[0].an * .5 + (x - this._pathData.f.v - p[0].an * .5 - p[p.length - 1].an * .5) * R / (M - 1), P += this._pathData.f.v); y;) C + T >= P + St || !g ? (I = (P + St - C) / S.partialLength, D = c.point[0] + (S.point[0] - c.point[0]) * I, Y = c.point[1] + (S.point[1] - c.point[1]) * I, r.translate(-i[0] * p[_].an * .005, -(i[1] * O) * .01), y = !1) : g && (C += S.partialLength, d += 1, d >= g.length && (d = 0, f += 1, A[f] ? g = A[f].points : N.v.c ? (d = 0, f = 0, g = A[f].points) : (C -= S.partialLength, g = null)), g && (c = S, S = g[d], T = S.partialLength));
							q = p[_].an / 2 - p[_].add, r.translate(-q, 0, 0);
						} else q = p[_].an / 2 - p[_].add, r.translate(-q, 0, 0), r.translate(-i[0] * p[_].an * .005, -i[1] * O * .01, 0);
						...
						for (t.strokeWidthAnim && (mt = t.sw || 0), t.strokeColorAnim && (t.sc ? nt = [
							t.sc[0],
							t.sc[1],
							t.sc[2]
						] : nt = [
							...
							t.fc[1],
							t.fc[2]
						]), a = 0; a < l; a += 1) v = s[a].a, v.a.propType && (k = s[a].s, w = k.getMult(p[_].anIndexes[a], n.a[a].s.totalChars), w.length ? r.translate(-v.a.v[0] * w[0], -v.a.v[1] * w[1], v.a.v[2] * w[2]) : r.translate(-v.a.v[0] * w, -v.a.v[1] * w, v.a.v[2] * w));
						...
						if (t.strokeWidthAnim && (xt = mt < 0 ? 0 : mt), t.strokeColorAnim && (Dt = "rgb(" + Math.round(nt[0] * 255) + "," + Math.round(nt[1] * 255) + "," + Math.round(nt[2] * 255) + ")"), t.fillColorAnim && t.fc && (Ft = "rgb(" + Math.round(K[0] * 255) + "," + Math.round(K[1] * 255) + "," + Math.round(K[2] * 255) + ")"), this._hasMaskedPath) {
							if (r.translate(0, -t.ls), r.translate(0, i[1] * O * .01 + m, 0), this._pathData.p.v) {
							...
							r.translate(D, Y, 0), P -= i[0] * p[_].an * .005, p[_ + 1] && R !== p[_ + 1].ind && (P += p[_].an / 2, P += t.tr * .001 * t.finalSize);
						} else {
							...
							r.translate(0, -t.ls), r.translate(q, 0, 0), r.translate(i[0] * p[_].an * .005, i[1] * O * .01, 0), h += p[_].l + t.tr * .001 * t.finalSize;
						}
						o === "html" ? Ct = r.toCSS() : o === "svg" ? Ct = r.to2dCSS() : It = [
							r.props[0],
							r.props[1],
							r.props[2],
							r.props[3],
					...
					u <= _ ? (E = new oi(Lt, xt, Dt, Ft, Ct, It), this.renderedLetters.push(E), u += 1, this.lettersChangedFlag = !0) : (E = this.renderedLetters[_], this.lettersChangedFlag = E.update(Lt, xt, Dt, Ft, Ct, It) || this.lettersChangedFlag);
				}
			}
		...
		}, yt.prototype.emptyProp = new oi(), yt.prototype.destroy = function() {}, yt.prototype.validateText = function() {
		...
		X([
			...
			Se,
			yt
		], Mt), Mt.prototype.createContent = function() {
			...
			e = o.length;
			var h, m = this.mHelper, _ = "", M = this.data.singleShape, p = 0, b = 0, P = !0, S = i.tr * .001 * i.finalSize;
			if (M && !u && !i.sz) {
				...
				for (e = d.length, b = i.ps ? i.ps[1] + i.ascent : 0, t = 0; t < e; t += 1) h = this.textSpans[t].span || W("tspan"), h.textContent = d[t], h.setAttribute("x", 0), h.setAttribute("y", b), h.style.display = "inherit", C.appendChild(h), this.textSpans[t] || (this.textSpans[t] = {
					span: null,
					glyph: null
				...
				for (t = 0; t < e; t += 1) {
					...
					if (m.reset(), M && (o[t].n && (p = -S, b += i.yOffset, b += P ? 1 : 0, P = !1), this.applyTextPropertiesToMatrix(i, m, o[t].line, p, b), p += o[t].l || 0, p += S), u) {
						...
						this.textSpans[t].glyph = A, A._debug = !0, A.prepareFrame(0), A.renderFrame(), this.textSpans[t].childSpan.appendChild(A.layerElement), c.t === 1 && this.textSpans[t].childSpan.setAttribute("transform", "scale(" + i.finalSize / 100 + "," + i.finalSize / 100 + ")");
					} else M && h.setAttribute("transform", "translate(" + m.props[12] + "," + m.props[13] + ")"), h.textContent = o[t].val, h.setAttributeNS("http://www.w3.org/XML/1998/namespace", "xml:space", "preserve");
				}
		...
		jt.prototype.prepareFrame = function(t) {
			...
			return null;
		}, jt.prototype.destroy = function() {}, jt.prototype.sourceRectAtTime = function() {}, jt.prototype.hide = function() {}, X([
			Nt,
			re,
			ne,
			zt
		...
		}, it.prototype.updateContainerSize = function() {}, it.prototype.findIndexByInd = function(t) {
		...
		X([
			...
			zt,
			Se
		], Et), Et.prototype.initElement = function(t, e, i) {
		...
		X([
			...
			Et,
			be
		], Ae), Ae.prototype.createComp = function(t) {
...
//#endregion
export { lottie_lightKMJEUZFY as default };

//# sourceMappingURL=lottie_light-KMJEUZFY-BLO7hvr9.js.map